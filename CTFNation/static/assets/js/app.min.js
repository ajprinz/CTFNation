(function() {
    ...
    var l, h, e, i, o, n, s, r, a, _, c, u, b, d, p, f, g, y, w, m, v, C, x, k, T, D, S, E, I, A, P, N, O, M, $, H, L, W, R, F, j, z, q, B, U, Y, K, V, X, Q = [].slice, G = {}.hasOwnProperty, J = [].indexOf || function(t) {
    ...
    C = function() {
        ...
        for (e = arguments[0],
        o = 0,
        r = (n = 2 <= arguments.length ? Q.call(arguments, 1) : []).length; o < r; o++)
            if (i = n[o])
                for (t in i)
                    G.call(i, t) && (s = i[t],
                    null != e[t] && "object" == typeof e[t] && null != s && "object" == typeof s ? C(e[t], s) : e[t] = s);
        return e
    }
    ,
    g = function(t) {
    ...
    q = 0,
    U = (K = ["ajax", "document", "eventLag", "elements"]).length; q < U; q++)
        !0 === A[L = K[q]] && (A[L] = v[L]);
    function Z() {}
    function tt(t) {
        this.source = t,
    ...
    function st() {
        ...
        if (null != F && A.ajax.trackWebSockets) {
            window.WebSocket = function(t, e) {
                var i;
                return i = null != e ? new F(t,e) : new F(t),
                H("socket") && o.trigger("request", {
                    type: "socket",
                    url: t,
                    protocols: e,
                    request: i
    ...
    rt.prototype.getElement = function() {
        var t;
        if (null == this.el) {
            if (!(t = document.querySelector(A.target)))
                throw new a;
    ...
    rt.prototype.render = function() {
        ...
        s = 0,
        o = (r = ["webkitTransform", "msTransform", "transform"]).length; s < o; s++)
            e = r[s],
    ...
    H = function(t) {
        ...
        "track" === S[0])
            return "force";
        if (!S.length && A.ajax) {
            if ("socket" === t && A.ajax.trackWebSockets)
                return !0;
            if (e = t.toUpperCase(),
            0 <= J.call(A.ajax.trackMethods, e))
                return !0
        }
        return !1
    }
    ...
    $ = function(t) {
        var e, i, n, s;
        for (i = 0,
        n = (s = A.ajax.ignoreURLs).length; i < n; i++)
    ...
    (T = function() {
        ...
        r = t.request,
        i = t.url,
        $(i) ? void 0 : _.running || !1 === A.restartOnRequestAfter && "force" !== H(a) ? void 0 : (o = arguments,
    ...
    nt.prototype.watch = function(t) {
        ...
        e = t.request,
        s = t.url,
        $(s) ? void 0 : (i = "socket" === n ? new d(e) : new p(e),
    ...
    p = function(e) {
        ...
        null != window.ProgressEvent)
            ...
            e.onreadystatechange = function() {
                var t;
                return 0 === (t = e.readyState) || 4 === t ? r.progress = 100 : 3 === e.readyState && (r.progress = 50),
    ...
    d = function(t) {
        var e, i, n, s, o = this;
        for (i = this.progress = 0,
        n = (s = ["error", "open"]).length; i < n; i++)
            e = s[i],
    ...
    n = function() {
        ...
        i = setInterval(function() {
            ...
            e = g(o),
            ++s >= A.eventLag.minSamples && e < A.eventLag.lagThreshold ? (r.progress = 100,
            clearInterval(i)) : r.progress = 3 / (e + 3) * 100
        }, 50)
    }
    ,
    ...
    (E = function() {
        ...
        n = (o = ["ajax", "elements", "document", "eventLag"]).length; e < n; e++)
            !1 !== A[t = o[e]] && W.push(new u[t](A[t]));
        for (i = 0,
        s = (a = null != (r = A.extraSources) ? r : []).length; i < s; i++)
            L = a[i],
            W.push(new L(A));
        return _.bar = y = new h,
        M = [],
        R = new b
    }
    )(),
    ...
    _.go = function() {
        ...
        f = O(function(t, e) {
            ...
            f = W.length; d < f; a = ++d)
                ...
                c = null != M[a] ? M[a] : M[a] = [],
                l = p = 0,
                g = (r = null != (m = L.elements) ? m : [L]).length; p < g; l = ++p)
                    o = r[l],
    ...
    _.start = function(t) {
        ...
        return document.querySelector(".pace") ? (_.trigger("start"),
        _.go()) : setTimeout(_.start, 50)
    }
    ,
...
function(t, e) {
    ...
    T.extend = T.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (t = arguments[a]))
                for (e in t)
                    n = t[e],
                    "__proto__" !== e && r !== n && (h && n && (T.isPlainObject(n) || (s = Array.isArray(n))) ? (i = r[e],
                    o = s && !Array.isArray(i) ? [] : s || T.isPlainObject(i) ? i : {},
                    s = !1,
                    r[e] = T.extend(h, o, n)) : void 0 !== n && (r[e] = n));
        return r
    }
    ,
    T.extend({
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (d(Object(t)) ? T.merge(i, "string" == typeof t ? [t] : t) : l.call(i, t)),
            i
        },
    ...
    var p = function(i) {
        ...
        var t, p, y, o, r, f, d, g, w, l, h, C, x, a, k, m, c, v, _, T = "sizzle" + 1 * new Date, b = i.document, D = 0, n = 0, S = lt(), E = lt(), I = lt(), A = lt(), P = function(t, e) {
            return t === e && (h = !0),
            0
            ...
            for (var i = 0, n = t.length; i < n; i++)
                if (t[i] === e)
                    return i;
            return -1
        }, W = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", R = "[\\x20\\t\\r\\n\\f]", F = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", j = "\\[" + R + "*(" + F + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + F + "))|)" + R + "*\\]", z = ":(" + F + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + j + ")*)|.*)\\)|)", q = new RegExp(R + "+","g"), B = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$","g"), U = new RegExp("^" + R + "*," + R + "*"), Y = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"), K = new RegExp(R + "|>"), V = new RegExp(z), X = new RegExp("^" + F + "$"), Q = {
            ID: new RegExp("^#(" + F + ")"),
            CLASS: new RegExp("^\\.(" + F + ")"),
            TAG: new RegExp("^(" + F + "|[*])"),
            ATTR: new RegExp("^" + j),
        ...
        }, G = /HTML$/i, J = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, tt = /^[^{]+\{\s*\[native \w/, et = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, it = /[+~]/, nt = new RegExp("\\\\([\\da-f]{1,6}" + R + "?|(" + R + ")|.)","ig"), st = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, ot = function(t, e) {
        ...
        function at(t, e, i, n) {
            ...
            "string" != typeof t || !t || 1 !== d && 9 !== d && 11 !== d)
                return i;
            if (!n && ((e ? e.ownerDocument || e : b) !== x && C(e),
            e = e || x,
            k)) {
                if (11 !== d && (l = et.exec(t)))
                    if (s = l[1]) {
                ...
                if (p.qsa && !A[t + " "] && (!m || !m.test(t)) && (1 !== d || "object" !== e.nodeName.toLowerCase())) {
                    ...
                    u = e,
                    1 === d && K.test(t)) {
                        for ((a = e.getAttribute("id")) ? a = a.replace(st, ot) : e.setAttribute("id", a = T),
                        o = (h = f(t)).length; o--; )
                            h[o] = "#" + a + " " + bt(h[o]);
                        c = h.join(","),
                        u = it.test(t) && vt(e.parentNode) || e
                    }
                    try {
                        return $.apply(i, u.querySelectorAll(c)),
                        i
                    } catch (e) {
                        A(t, !0)
                    } finally {
        ...
        function lt() {
            ...
            return function t(e, i) {
                return n.push(e + " ") > y.cacheLength && delete t[n.shift()],
                t[e + " "] = i
            }
        }
        function ht(t) {
        ...
        C = at.setDocument = function(t) {
            ...
            return n !== x && 9 === n.nodeType && n.documentElement && (a = (x = n).documentElement,
            k = !r(x),
            ...
            c = [],
            m = [],
            (p.qsa = tt.test(x.querySelectorAll)) && (ct(function(t) {
            ...
            _ = e || tt.test(a.contains) ? function(t, e) {
            ...
            : function(t, e) {
                ...
                if (!s || !o)
                    return t === x ? -1 : e === x ? 1 : s ? -1 : o ? 1 : l ? L(l, t) - L(l, e) : 0;
                if (s === o)
                    return dt(t, e);
        ...
        at.matchesSelector = function(t, e) {
            if ((t.ownerDocument || t) !== x && C(t),
            p.matchesSelector && k && !A[e + " "] && (!c || !c.test(e)) && (!m || !m.test(e)))
                try {
                    var i = v.call(t, e);
        ...
        at.contains = function(t, e) {
            return (t.ownerDocument || t) !== x && C(t),
            _(t, e)
        }
        ,
            ...
            filter: {
                ...
                ATTR: function(i, n, s) {
                    return function(t) {
                        var e = at.attr(t, i);
                        return null == e ? "!=" === n : !n || (e += "",
                        "=" === n ? e === s : "!=" === n ? e !== s : "^=" === n ? s && 0 === e.indexOf(s) : "*=" === n ? s && -1 < e.indexOf(s) : "$=" === n ? s && e.slice(-s.length) === s : "~=" === n ? -1 < (" " + e.replace(q, " ") + " ").indexOf(s) : "|=" === n && (e === s || e.slice(0, s.length + 1) === s + "-"))
                    }
                },
                CHILD: function(f, t, e, g, m) {
                    ...
                    : function(t, e, i) {
                        var n, s, o, r, a, l, h = v != _ ? "nextSibling" : "previousSibling", c = t.parentNode, u = b && t.nodeName.toLowerCase(), d = !i && !b, p = !1;
                        if (c) {
                            if (v) {
                                for (; h; ) {
                                    for (r = t; r = r[h]; )
                            ...
                            if (l = [_ ? c.firstChild : c.lastChild],
                            _ && d) {
                                for (p = (a = (n = (s = (o = (r = c)[T] || (r[T] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] || [])[0] === D && n[1]) && n[2],
                                r = a && c.childNodes[a]; r = ++a && r && r[h] || (p = a = 0) || l.pop(); )
                                    if (1 === r.nodeType && ++p && r === t) {
                                        s[f] = [D, a, p];
                                        break
                                    }
                            } else if (d && (p = a = (n = (s = (o = (r = t)[T] || (r[T] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] || [])[0] === D && n[1]),
                            !1 === p)
                                for (; (r = ++a && r && r[h] || (p = a = 0) || l.pop()) && ((b ? r.nodeName.toLowerCase() !== u : 1 !== r.nodeType) || !++p || (d && ((s = (o = r[T] || (r[T] = {}))[r.uniqueID] || (o[r.uniqueID] = {}))[f] = [D, p]),
                                r !== t)); )
                                    ;
                ...
                PSEUDO: function(t, o) {
                    ...
                    return r[T] ? r(o) : 1 < r.length ? (e = [t, t, "", o],
                    y.setFilters.hasOwnProperty(t.toLowerCase()) ? ht(function(t, e) {
            ...
            pseudos: {
                not: ht(function(t) {
                    var n = []
                      , s = []
                      , a = d(t.replace(B, "$1"));
                    return a[T] ? ht(function(t, e, i, n) {
                ...
                lang: ht(function(i) {
                    return X.test(i || "") || at.error("unsupported lang: " + i),
        ...
        function yt(a, t, e) {
            ...
            : function(t, e, i) {
                ...
                if (i) {
                    ...
                    for (; t = t[l]; )
                        if (1 === t.nodeType || u)
                            if (s = (o = t[T] || (t[T] = {}))[t.uniqueID] || (o[t.uniqueID] = {}),
                            h && h === t.nodeName.toLowerCase())
                                t = t[l] || t;
                            else {
                                if ((n = s[c]) && n[0] === D && n[1] === d)
                                    return r[2] = n[2];
                                if ((s[c] = r)[2] = a(t, e, i))
                                    return !0
                            }
            ...
            ht(function(t, e, i, n) {
                var s, o, r, a = [], l = [], h = e.length, c = t || function(t, e, i) {
                    for (var n = 0, s = e.length; n < s; n++)
                        at(t, e[n], i);
                    return i
                }(f || "*", i.nodeType ? [i] : i, []), u = !p || !t && f ? c : Ct(c, a, p, i, n), d = g ? v || (t ? p : h || m) ? [] : e : u;
                if (g && g(u, d, i, n),
                m)
                    for (s = Ct(d, l),
                    m(s, [], i, n),
                ...
                if (t) {
                    ...
                    d = Ct(d === e ? d.splice(h, d.length) : d),
        ...
        return _t.prototype = y.filters = y.pseudos,
        y.setFilters = new _t,
        f = at.tokenize = function(t, e) {
            ...
            a = [],
            l = y.preFilter; r; ) {
                for (o in i && !(n = U.exec(r)) || (n && (r = r.slice(n[0].length) || r),
                a.push(s = [])),
                i = !1,
                ...
                r = r.slice(i.length)),
                y.filter)
                    !(n = Q[o].exec(r)) || l[o] && !(n = l[o](n)) || (i = n.shift(),
                    s.push({
                        value: i,
                        type: o,
                        matches: n
        ...
        d = at.compile = function(t, e) {
            ...
            if (!r) {
                for (i = (e = e || f(t)).length; i--; )
                    (r = kt(e[i]))[T] ? s.push(r) : o.push(r);
                (r = I(t, (m = o,
                _ = 0 < (v = s).length,
                b = 0 < m.length,
                n = function(t, e, i, n, s) {
                    var o, r, a, l = 0, h = "0", c = t && [], u = [], d = w, p = t || b && y.find.TAG("*", s), f = D += null == d ? 1 : Math.random() || .1, g = p.length;
                    for (s && (w = e === x || e || s); h !== g && null != (o = p[h]); h++) {
                        if (b && o) {
                            for (r = 0,
                            e || o.ownerDocument === x || (C(o),
                            i = !k); a = m[r++]; )
                                if (a(o, e || x, i)) {
                                    n.push(o);
                                    break
                    ...
                    _ && h !== l) {
                        ...
                        if (t) {
                            if (0 < l)
                                for (; h--; )
                                    c[h] || u[h] || (u[h] = O.call(n));
                            u = Ct(u)
                        }
                        $.apply(n, u),
                        s && !t && 0 < u.length && 1 < l + v.length && at.uniqueSort(n)
                    }
                    return s && (D = f,
                    w = d),
                    c
        ...
        g = at.select = function(t, e, i, n) {
            ...
            1 === c.length) {
                ...
                for (s = Q.needsContext.test(t) ? 0 : o.length; s-- && (r = o[s],
                !y.relative[a = r.type]); )
            ...
            return (h || d(t, c))(n, e, !k, i, !e || it.test(t) && vt(e.parentNode) || e),
            i
        }
        ,
    ...
    (T.fn.init = function(t, e, i) {
        ...
        "string" != typeof t)
            ...
            this.length = 1,
            this) : b(t) ? void 0 !== i.ready ? i.ready(t) : t(T) : T.makeArray(t, this);
        if (!(n = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : P.exec(t)) || !n[1] && e)
            return !e || e.jquery ? (e || i).find(t) : this.constructor(e).find(t);
        if (n[1]) {
            if (e = e instanceof T ? e[0] : e,
            T.merge(this, T.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : k, !0)),
            E.test(n[1]) && T.isPlainObject(e))
                for (n in e)
                    b(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
            return this
        }
        return (s = k.getElementById(n[2])) && (this[0] = s,
        this.length = 1),
        this
    }
    ).prototype = T.fn,
    ...
    T.each({
        ...
        contents: function(t) {
            return void 0 !== t.contentDocument ? t.contentDocument : (S(t, "template") && (t = t.content || t),
        ...
        T.fn[n] = function(t, e) {
            ...
            1 < this.length && (O[n] || T.uniqueSort(i),
            N.test(n) && i.reverse()),
            this.pushStack(i)
        }
    });
    ...
    T.Callbacks = function(n) {
        ...
        function s() {
            for (a = a || n.once,
            r = o = !0; h.length; c = -1)
                for (e = h.shift(); ++c < l.length; )
                    !1 === l[c].apply(e[0], e[1]) && n.stopOnFalse && (c = l.length,
                    e = !1);
            n.memory || (e = !1),
            o = !1,
            a && (l = e ? [] : "")
        }
        var o, e, r, a, l = [], h = [], c = -1, u = {
            add: function() {
    ...
    T.extend({
                        ...
                        return function() {
                            function t() {
                                ...
                                if (!(s < l)) {
                                    ...
                                    b(e) ? a ? e.call(t, h(l, o, H, a), h(l, o, L, a)) : (l++,
                                    e.call(t, h(l, o, H, a), h(l, o, L, a), h(l, o, H, o.notifyWith))) : (r !== H && (i = void 0,
                                    n = [t]),
                                    (a || o.resolveWith)(i, n))
                                }
                            }
                            ...
                            ;
                            s ? e() : (T.Deferred.getStackHook && (e.stackTrace = T.Deferred.getStackHook()),
                            x.setTimeout(e))
                        }
                    }
        ...
        when: function(t) {
            ...
            var i = arguments.length
              ...
              , o = a.call(arguments)
              , r = T.Deferred();
            if (i <= 1 && (W(t, r.done(e(n)).resolve, r.reject, !i),
    ...
    T.ready.then = F.then,
    "complete" === k.readyState || "loading" !== k.readyState && !k.documentElement.doScroll ? x.setTimeout(T.ready) : (k.addEventListener("DOMContentLoaded", j),
        ...
        data: function(i, t) {
            ...
            if (void 0 !== i)
                return "object" == typeof i ? this.each(function() {
                    ...
                    var e;
                    if (o && void 0 === t)
                        return void 0 !== (e = Q.get(o, i)) ? e : void 0 !== (e = Z(o, i)) ? e : void 0;
                    this.each(function() {
                        Q.set(this, i, t)
                    })
                }, null, t, 1 < arguments.length, null, !0);
            if (this.length && (s = Q.get(o),
            1 === o.nodeType && !X.get(o, "hasDataAttrs"))) {
                for (e = r.length; e--; )
                    r[e] && 0 === (n = r[e].name).indexOf("data-") && (n = Y(n.slice(5)),
                    Z(o, n, s[n]));
    ...
    T.extend({
        queue: function(t, e, i) {
            ...
            if (t)
                return e = (e || "fx") + "queue",
                n = X.get(t, e),
                i && (!n || Array.isArray(i) ? n = X.access(t, e, T.makeArray(i)) : n.push(i)),
                n || []
        },
    ...
    T.fn.extend({
        ...
        promise: function(t, e) {
            ...
            t = void 0),
            t = t || "fx"; a--; )
                (n = X.get(r[a], t + "queueHooks")) && n.empty && (s++,
                n.empty.add(i));
            return i(),
            o.promise(e)
        }
    ...
    function lt(t, e, i, n) {
        ...
        , l = a(), h = i && i[3] || (T.cssNumber[e] ? "" : "px"), c = t.nodeType && (T.cssNumber[e] || "px" !== h && +l) && et.exec(T.css(t, e));
        if (c && c[3] !== h) {
            for (l /= 2,
            h = h || c[3],
            c = +l || 1; r--; )
    ...
    function ct(t, e) {
        for (var i, n, s, o, r, a, l, h = [], c = 0, u = t.length; c < u; c++)
            ...
            e ? ("none" === i && (h[c] = X.get(n, "display") || null,
            h[c] || (n.style.display = "")),
            "" === n.style.display && rt(n) && (h[c] = (l = r = o = void 0,
            r = (s = n).ownerDocument,
            a = s.nodeName,
            (l = ht[a]) || (o = r.body.appendChild(r.createElement(a)),
            l = T.css(o, "display"),
            o.parentNode.removeChild(o),
            "none" === l && (l = "block"),
            ht[a] = l)))) : "none" !== i && (h[c] = "none",
            X.set(n, "display", i)));
        for (c = 0; c < u; c++)
    ...
    function gt(t, e) {
        ...
        void 0 === e || e && S(t, e) ? T.merge([t], i) : i
    }
    function mt(t, e) {
        for (var i = 0, n = t.length; i < n; i++)
        ...
        for (var o, r, a, l, h, c, u = e.createDocumentFragment(), d = [], p = 0, f = t.length; p < f; p++)
            if ((o = t[p]) || 0 === o)
                if ("object" === w(o))
                    ...
                    c = l[0]; c--; )
                        r = r.lastChild;
                    T.merge(d, r.childNodes),
                    (r = u.firstChild).textContent = ""
                } else
                    d.push(e.createTextNode(o));
        for (u.textContent = "",
        p = 0; o = d[p++]; )
            if (n && -1 < T.inArray(o, n))
                s && s.push(o);
            else if (h = st(o),
            r = gt(u.appendChild(o), "script"),
            h && mt(r),
            i)
                for (c = 0; o = r[c++]; )
        ...
        T.event.add(t, s, {
            ...
            handler: function(t) {
                ...
                if (1 & t.isTrigger && this[s]) {
                    if (n.length)
                        (T.event.special[s] || {}).delegateType && t.stopPropagation();
                    else if (n = a.call(arguments),
                    X.set(this, s, n),
                    e = o(this, s),
                    this[s](),
                    n !== (i = X.get(this, s)) || e ? X.set(this, s, !1) : i = {},
                    n !== i)
                        return t.stopImmediatePropagation(),
                        t.preventDefault(),
                        i.value
                } else
                    n.length && (X.set(this, s, {
    ...
    T.event = {
            ...
            if (m && (l = m.events)) {
                for (h = (e = (e || "").match($) || [""]).length; h--; )
                    ...
                    p) {
                        ...
                        r && !d.length && (u.teardown && !1 !== u.teardown.call(t, f, m.handle) || T.removeEvent(t, p, m.handle),
                        delete l[p])
                    } else
                        for (p in l)
        ...
        dispatch: function(t) {
            var e, i, n, s, o, r, a = T.event.fix(t), l = new Array(arguments.length), h = (X.get(this, "events") || {})[a.type] || [], c = T.event.special[a.type] || {};
            for (l[0] = a,
            ...
            !c.preDispatch || !1 !== c.preDispatch.call(this, a)) {
                ...
                e = 0; (s = r[e++]) && !a.isPropagationStopped(); )
                    ...
                    i = 0; (o = s.handlers[i++]) && !a.isImmediatePropagationStopped(); )
                        ...
                        a.data = o.data,
                        void 0 !== (n = ((T.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, l)) && !1 === (a.result = n) && (a.preventDefault(),
                        a.stopPropagation()));
            ...
            if (l && h.nodeType && !("click" === t.type && 1 <= t.button))
                for (; h !== this; h = h.parentNode || this)
                    if (1 === h.nodeType && ("click" !== t.type || !0 !== h.disabled)) {
                        ...
                        r = {},
                        i = 0; i < l; i++)
                            void 0 === r[s = (n = e[i]).selector + " "] && (r[s] = n.needsContext ? -1 < T(s, this).index(h) : T.find(s, this, null, [h]).length),
                            r[s] && o.push(n);
                        o.length && a.push({
                            elem: h,
                            handlers: o
        ...
        special: {
            ...
            click: {
                setup: function(t) {
                    var e = this || t;
                    return ut.test(e.type) && e.click && S(e, "input") && Et(e, "click", kt),
                    !1
                },
                trigger: function(t) {
                    var e = this || t;
                    return ut.test(e.type) && e.click && S(e, "input") && Et(e, "click"),
                    !0
                },
                _default: function(t) {
                    var e = t.target;
    ...
    function Lt(i, n, s, o) {
        ...
        if (u && (e = (t = yt(n, i[0].ownerDocument, !1, i, o)).firstChild,
        1 === t.childNodes.length && (t = e),
        e || o)) {
            for (a = (r = T.map(gt(t, "script"), Mt)).length; c < u; c++)
                l = t,
                c !== d && (l = T.clone(l, !0, !0),
            ...
            if (a)
                ...
                c = 0; c < a; c++)
                    l = r[c],
                    pt.test(l.type || "") && !X.access(l, "globalEval") && T.contains(h, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, {
    ...
    function Wt(t, e, i) {
        for (var n, s = e ? T.filter(e, t) : t, o = 0; null != (n = s[o]); o++)
            ...
            n.parentNode && (i && st(n) && mt(gt(n, "script")),
    ...
    T.extend({
        ...
        clone: function(t, e, i) {
            ...
            if (!(_.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || T.isXMLDoc(t)))
                for (r = gt(c),
                n = 0,
                s = (o = gt(t)).length; n < s; n++)
                    a = o[n],
                    "input" === (h = (l = r[n]).nodeName.toLowerCase()) && ut.test(a.type) ? l.checked = a.checked : "input" !== h && "textarea" !== h || (l.defaultValue = a.defaultValue);
            if (e)
                if (i)
                    for (o = o || gt(t),
                    r = r || gt(c),
                    ...
                    Ht(t, c);
            return 0 < (r = gt(c, "script")).length && mt(r, !u && gt(t, "script")),
            c
        },
    ...
    T.fn.extend({
        ...
        replaceWith: function() {
            ...
            return Lt(this, arguments, function(t) {
                ...
                T.inArray(this, i) < 0 && (T.cleanData(gt(this)),
    ...
    var Rt, Ft, jt, zt, qt, Bt, Ut, Yt = new RegExp("^(" + tt + ")(?!px)[a-z%]+$","i"), Kt = function(t) {
    ...
    function Xt(t, e, i) {
        ...
        return (i = i || Kt(t)) && ("" !== (r = i.getPropertyValue(e) || i[e]) || st(t) || (r = T.style(t, e)),
        !_.pixelBoxStyles() && Yt.test(r) && Vt.test(e) && (n = a.width,
        s = a.minWidth,
        o = a.maxWidth,
    ...
    (Ut = k.createElement("div")).style && (Ut.style.backgroundClip = "content-box",
    ...
    function le(t, e, i, n, s, o) {
        ...
        for (; r < 4; r += 2)
            ...
            n ? ("content" === i && (l -= T.css(t, "padding" + it[r], !0, s)),
            "margin" !== i && (l -= T.css(t, "border" + it[r] + "Width", !0, s))) : (l += T.css(t, "padding" + it[r], !0, s),
            "padding" !== i ? l += T.css(t, "border" + it[r] + "Width", !0, s) : a += T.css(t, "border" + it[r] + "Width", !0, s));
    ...
    function he(t, e, i) {
        ...
        return (!_.boxSizingReliable() && s || "auto" === r || !parseFloat(r) && "inline" === T.css(t, "display", !1, n)) && t.getClientRects().length && (s = "border-box" === T.css(t, "boxSizing", !1, n),
        (o = a in t) && (r = t[a])),
    ...
    T.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                ...
                "string" == (o = typeof i) && (s = et.exec(i)) && s[1] && (i = lt(t, e, s),
                o = "number"),
                null != i && i == i && ("number" !== o || l || (i += s && s[3] || (T.cssNumber[a] ? "" : "px")),
    ...
    T.each(["height", "width"], function(t, l) {
        T.cssHooks[l] = {
            get: function(t, e, i) {
                if (e)
                    return !ne.test(T.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? he(t, l, i) : at(t, oe, function() {
                        return he(t, l, i)
                    })
            },
            set: function(t, e, i) {
                var n, s = Kt(t), o = !_.scrollboxSize() && "absolute" === s.position, r = (o || i) && "border-box" === T.css(t, "boxSizing", !1, s), a = i ? le(t, l, i, r, s) : 0;
                return r && o && (a -= Math.ceil(t["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(s[l]) - le(t, l, "border", !1, s) - .5)),
    ...
    function ve() {
        de && (!1 === k.hidden && x.requestAnimationFrame ? x.requestAnimationFrame(ve) : x.setTimeout(ve, T.fx.interval),
        T.fx.tick())
    }
    function _e() {
    ...
    function we(o, t, e) {
        var i, r, n = 0, s = we.prefilters.length, a = T.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (r)
                return !1;
            for (var t = ue || _e(), e = Math.max(0, h.startTime + h.duration - t), i = 1 - (e / h.duration || 0), n = 0, s = h.tweens.length; n < s; n++)
                h.tweens[n].run(i);
            return a.notifyWith(o, [h, i, e]),
            i < 1 && s ? e : (s || a.notifyWith(o, [h, 1, 0]),
            a.resolveWith(o, [h]),
            !1)
        }, h = a.promise({
            elem: o,
    ...
    T.Animation = T.extend(we, {
        tweeners: {
            "*": [function(t, e) {
                ...
                return lt(i.elem, t, et.exec(e), i),
                i
            }
            ]
        },
        tweener: function(t, e) {
            for (var i, n = 0, s = (t = b(t) ? (e = t,
            ["*"]) : t.match($)).length; n < s; n++)
                i = t[n],
                we.tweeners[i] = we.tweeners[i] || [],
                we.tweeners[i].unshift(e)
        },
        prefilters: [function(t, e, i) {
            var n, s, o, r, a, l, h, c, u = "width"in e || "height"in e, d = this, p = {}, f = t.style, g = t.nodeType && rt(t), m = X.get(t, "fxshow");
            ...
            if ((l = !T.isEmptyObject(e)) || !T.isEmptyObject(p))
                ...
                "none" === (c = T.css(t, "display")) && (h ? c = h : (ct([t], !0),
                h = t.style.display || h,
                c = T.css(t, "display"),
                ct([t]))),
                ("inline" === c || "inline-block" === c && null != h) && "none" === T.css(t, "float") && (l || (d.done(function() {
                    f.display = h
                }),
                null == h && (c = f.display,
                h = "none" === c ? "" : c)),
    ...
    T.fn.extend({
        ...
        finish: function(r) {
            return !1 !== r && (r = r || "fx"),
            this.each(function() {
                var t, e = X.get(this), i = e[r + "queue"], n = e[r + "queueHooks"], s = T.timers, o = i ? i.length : 0;
                for (e.finish = !0,
                T.queue(this, r, []),
    ...
    T.extend({
        attr: function(t, e, i) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === t.getAttribute ? T.prop(t, e, i) : (1 === o && T.isXMLDoc(t) || (s = T.attrHooks[e.toLowerCase()] || (T.expr.match.bool.test(e) ? Ce : void 0)),
                void 0 !== i ? null === i ? void T.removeAttr(t, e) : s && "set"in s && void 0 !== (n = s.set(t, i, e)) ? n : (t.setAttribute(e, i + ""),
                i) : s && "get"in s && null !== (n = s.get(t, e)) ? n : null == (n = T.find.attr(t, e)) ? void 0 : n)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        toggleClass: function(s, e) {
            ...
            return "boolean" == typeof e && r ? e ? this.addClass(s) : this.removeClass(s) : b(s) ? this.each(function(t) {
                ...
                if (r)
                    ...
                    void 0 !== s && "boolean" != o || ((t = Se(this)) && X.set(this, "__className__", t),
                    this.setAttribute && this.setAttribute("class", t || !1 === s ? "" : X.get(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e, i, n = 0;
            for (e = " " + t + " "; i = this[n++]; )
                if (1 === i.nodeType && -1 < (" " + De(Se(i)) + " ").indexOf(e))
                    return !0;
            return !1
        }
    });
    ...
    T.fn.extend({
        val: function(i) {
            ...
            })) : e ? (n = T.valHooks[e.type] || T.valHooks[e.nodeName.toLowerCase()]) && "get"in n && void 0 !== (t = n.get(e, "value")) ? t : "string" == typeof (t = e.value) ? t.replace(Ie, "") : null == t ? "" : t : void 0
        }
    }),
    T.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var i, n, s = t.options, o = T.makeArray(e), r = s.length; r--; )
                        ((n = s[r]).selected = -1 < T.inArray(T.valHooks.option.get(n), o)) && (i = !0);
    ...
    T.extend(T.event, {
        trigger: function(t, e, i, n) {
            var s, o, r, a, l, h, c, u, d = [i || k], p = v.call(t, "type") ? t.type : t, f = v.call(t, "namespace") ? t.namespace.split(".") : [];
            if (o = u = r = i = i || k,
            3 !== i.nodeType && 8 !== i.nodeType && !Pe.test(p + T.event.triggered) && (-1 < p.indexOf(".") && (p = (f = p.split(".")).shift(),
            f.sort()),
            l = p.indexOf(":") < 0 && "on" + p,
            ...
            n || !c.trigger || !1 !== c.trigger.apply(i, e))) {
                if (!n && !c.noBubble && !g(i)) {
                    ...
                    Pe.test(a + p) || (o = o.parentNode); o; o = o.parentNode)
                        d.push(o),
                        r = o;
                ...
                for (s = 0; (o = d[s++]) && !t.isPropagationStopped(); )
                    ...
                    (h = l && o[l]) && h.apply && K(o) && (t.result = h.apply(o, e),
                    !1 === t.result && t.preventDefault());
                return t.type = p,
                n || t.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), e) || !K(i) || l && b(i[p]) && !g(i) && ((r = i[l]) && (i[l] = null),
                T.event.triggered = p,
    ...
    _.focusin || T.each({
        ...
        T.event.special[n] = {
            ...
            teardown: function() {
                var t = this.ownerDocument || this
                  , e = X.access(t, n) - 1;
                e ? X.access(t, n, e) : (t.removeEventListener(i, s, !0),
                X.remove(t, n))
            }
        }
    });
    ...
    T.extend({
        ...
        ajax: function(t, e) {
            ...
            t = void 0),
            e = e || {};
            var c, u, d, i, p, n, f, g, s, o, m = T.ajaxSetup({}, e), v = m.context || m, _ = m.context && (v.nodeType || v.jquery) ? T(v) : T.event, b = T.Deferred(), y = T.Callbacks("once memory"), w = m.statusCode || {}, r = {}, a = {}, l = "canceled", C = {
                readyState: 0,
            ...
            u = m.url.replace(je, ""),
            m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Fe, "+")) : (o = m.url.slice(u.length),
            m.data && (m.processData || "string" == typeof m.data) && (u += (Me.test(u) ? "&" : "?") + m.data,
            delete m.data),
            !1 === m.cache && (u = u.replace(ze, "$1"),
            o = (Me.test(u) ? "&" : "?") + "_=" + Oe++ + o),
            m.url = u + o),
            m.ifModified && (T.lastModified[u] && C.setRequestHeader("If-Modified-Since", T.lastModified[u]),
            ...
            function h(t, e, i, n) {
                ...
                s ? (m.ifModified && ((l = C.getResponseHeader("Last-Modified")) && (T.lastModified[u] = l),
                (l = C.getResponseHeader("etag")) && (T.etag[u] = l)),
                204 === t || "HEAD" === m.type ? h = "nocontent" : 304 === t ? h = "notmodified" : (h = a.state,
                o = a.data,
                s = !(r = a.error))) : (r = h,
                !t && h || (h = "error",
                t < 0 && (t = 0))),
                ...
                send: function(t, e) {
                    ...
                    o = function(t) {
                        return function() {
                            ...
                            "abort" === t ? n.abort() : "error" === t ? "number" != typeof n.status ? e(0, "error") : e(n.status, n.statusText) : e(Ze[n.status] || n.status, n.statusText, "text" !== (n.responseType || "text") || "string" != typeof n.responseText ? {
                                binary: n.response
                            } : {
                                text: n.responseText
    ...
    T.ajaxPrefilter("json jsonp", function(t, e, i) {
        ...
        if (r || "jsonp" === t.dataTypes[0])
            ...
            t.converters["script json"] = function() {
                return o || T.error(n + " was not called"),
                o[0]
            }
            ,
            t.dataTypes[0] = "json",
    ...
    _.createHTMLDocument = ((ei = k.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === ei.childNodes.length),
    T.parseHTML = function(t, e, i) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (i = e,
        e = !1),
        e || (_.createHTMLDocument ? ((n = (e = k.implementation.createHTMLDocument("")).createElement("base")).href = k.location.href,
        e.head.appendChild(n)) : e = k),
        o = !i && [],
        (s = E.exec(t)) ? [e.createElement(s[1])] : (s = yt([t], e, o),
    ...
    T.offset = {
        setOffset: function(t, e, i) {
            var n, s, o, r, a, l, h = T.css(t, "position"), c = T(t), u = {};
            "static" === h && (t.style.position = "relative"),
            a = c.offset(),
            o = T.css(t, "top"),
            l = T.css(t, "left"),
            s = ("absolute" === h || "fixed" === h) && -1 < (o + l).indexOf("auto") ? (r = (n = c.position()).top,
            ...
            if (this[0]) {
                ...
                if ("fixed" === T.css(n, "position"))
                    ...
                    t = n.offsetParent || i.documentElement; t && (t === i.body || t === i.documentElement) && "static" === T.css(t, "position"); )
                        t = t.parentNode;
                    t && t !== n && 1 === t.nodeType && ((s = T(t).offset()).top += T.css(t, "borderTopWidth", !0),
    ...
    T.each({
        ...
        T.each({
            ...
            T.fn[o] = function(t, e) {
                ...
                return z(this, function(t, e, i) {
                    var n;
                    return g(t) ? 0 === o.indexOf("outer") ? t["inner" + r] : t.document.documentElement["client" + r] : 9 === t.nodeType ? (n = t.documentElement,
...
function(t) {
    ...
    function o() {
        x.datepicker._isDisabledDatepicker(it.inline ? it.dpDiv.parent()[0] : it.input[0]) || (x(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),
    ...
    x.ui = x.ui || {},
    x.ui.version = "1.12.1";
    var n, s, C, k, r, a, l, h, c, T, d, p = 0, f = Array.prototype.slice;
    function D(t, e, i) {
    ...
    x.widget.extend = function(t) {
        for (var e, i, n = f.call(arguments, 1), s = 0, o = n.length; s < o; s++)
            for (e in n[s])
                i = n[s][e],
                n[s].hasOwnProperty(e) && void 0 !== i && (t[e] = x.isPlainObject(i) ? x.isPlainObject(t[e]) ? x.widget.extend({}, t[e], i) : x.widget.extend({}, i) : i);
        return t
    }
    ,
    x.widget.bridge = function(o, e) {
        ...
        x.fn[o] = function(i) {
            ...
            return t ? this.length || "instance" !== i ? this.each(function() {
                ...
                !1) : e ? x.isFunction(e[i]) && "_" !== i.charAt(0) ? (t = e[i].apply(e, n)) !== e && void 0 !== t ? (s = t && t.jquery ? s.pushStack(t.get()) : t,
            ...
            }) : s = void 0 : (n.length && (i = x.widget.extend.apply(null, [i].concat(n))),
            this.each(function() {
                var t = x.data(this, r);
                t ? (t.option(i || {}),
    ...
    x.Widget.prototype = {
        ...
        option: function(t, e) {
            ...
            if ("string" == typeof t)
                ...
                t = (i = t.split(".")).shift(),
                i.length) {
                    for (n = o[t] = x.widget.extend({}, this.options[t]),
                    s = 0; i.length - 1 > s; s++)
                        n[i[s]] = n[i[s]] || {},
                        n = n[i[s]];
                    if (t = i.pop(),
    ...
    x.each({
        ...
        x.Widget.prototype["_" + o] = function(e, t, i) {
            ...
            n && x.effects && x.effects.effect[s] ? e[o](t) : s !== o && e[s] ? e[s](t.duration, t.easing, i) : e.queue(function(t) {
                x(this)[o](),
                i && i.call(e[0]),
                t()
            })
    ...
    x.position = {
        scrollbarWidth: function() {
            if (void 0 !== s)
                return s;
            var t, e, i = x("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"), n = i.children()[0];
    ...
    x.fn.position = function(u) {
        ...
        u = x.extend({}, u);
        var d, p, f, g, m, t, v = x(u.of), _ = x.position.getWithinInfo(u.within), b = x.position.getScrollInfo(_), y = (u.collision || "flip").split(" "), w = {};
        return t = function(t) {
            var e = t[0];
            return 9 === e.nodeType ? {
                width: t.width(),
        ...
        m.top += d[1],
        this.each(function() {
            var i, t, r = x(this), a = r.outerWidth(), l = r.outerHeight(), e = S(this, "marginLeft"), n = S(this, "marginTop"), s = a + e + S(this, "marginRight") + b.width, o = l + n + S(this, "marginBottom") + b.height, h = x.extend({}, m), c = D(w.my, r.outerWidth(), r.outerHeight());
            ...
            u.using && (t = function(t) {
                ...
                o.important = C(k(e), k(i)) > C(k(n), k(s)) ? "horizontal" : "vertical",
    ...
    x.ui.position = {
        fit: {
            left: function(t, e) {
                ...
                t.left += a - i) : t.left = 0 < l && a <= 0 ? s : l < a ? s + o - e.collisionWidth : s : 0 < a ? t.left += a : 0 < l ? t.left -= l : t.left = C(t.left - r, t.left)
            },
            top: function(t, e) {
                ...
                t.top += a - i) : t.top = 0 < l && a <= 0 ? s : l < a ? s + o - e.collisionHeight : s : 0 < a ? t.top += a : 0 < l ? t.top -= l : t.top = C(t.top - r, t.top)
            }
        },
        flip: {
            left: function(t, e) {
    ...
    var g, m, v, _, b, y, w, E, I, A, P, N, O, M, $, H, L, W, R, F, j, z = "ui-effects-", q = "ui-effects-style", B = "ui-effects-animated", U = x;
    function Y(t, e, i, n) {
        ...
        i = null,
        e = {}),
        "number" != typeof e && !x.fx.speeds[e] || (n = i,
        i = e,
        e = {}),
        x.isFunction(i) && (n = i,
        i = null),
    ...
    function G(r) {
        ...
        l.length ? ("0,0,0,0" === l.join() && P.extend(l, O.transparent),
        a) : O[r]
    }
    function J(t, e, i) {
    ...
    H.fn = P.extend(H.prototype, {
        parse: function(s, t, e, i) {
            if (s === N)
                ...
                this;
            (s.jquery || s.nodeType) && (s = P(s).css(t),
            t = N);
            var o = this
              , n = P.type(s)
              , r = this._rgba = [];
            return t !== N && (s = [s, t, e, i],
            n = "array"),
            "string" === n ? this.parse(G(s) || O._default) : "array" === n ? (j(L.rgba.props, function(t, e) {
                r[e.idx] = Q(s[e.idx], e)
            }),
            ...
            : function(t, i) {
                ...
                o[n] && P.inArray(null, o[n].slice(0, 3)) < 0 && (o[n][3] = 1,
        ...
        transition: function(t, r) {
            ...
            j(i.props, function(t, e) {
                var i = e.idx
                  ...
                  , s = a[i]
                  , o = W[e.type] || {};
                null !== s && (null === n ? h[i] = s : (o.mod && (s - n > o.mod / 2 ? n += o.mod : n - s > o.mod / 2 && (n -= o.mod)),
                h[i] = Q((s - n) * r + n, e)))
            }),
            this[e](h)
        },
    ...
    j(L, function(l, t) {
        ...
        j(i, function(r, a) {
            H.fn[r] || (H.fn[r] = function(t) {
                ...
                i = P.type(t)),
                null == t && a.empty ? this : ("string" === i && (e = M.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)),
                s[a.idx] = t,
                this[n](s)))
            }
            )
        ...
        return this.queue(function() {
            ...
            n = n.map(function() {
                ...
                this.diff = function(t, e) {
                    ...
                    for (i in e)
                        n = e[i],
                        t[i] !== n && (A[i] || !x.fx.step[i] && isNaN(parseFloat(n)) || (s[i] = n));
                    return s
                }(this.start, this.end),
                this
            }),
    ...
    x.expr && x.expr.filters && x.expr.filters.animated && (x.expr.filters.animated = (b = x.expr.filters.animated,
    function(t) {
    ...
    x.fn.extend({
        effect: function() {
            function t(t) {
                function e() {
                    x.isFunction(a) && a.call(i[0]),
                    x.isFunction(t) && t()
                }
                var i = x(this);
                n.mode = h.shift(),
                !1 === x.uiBackCompat || o ? "none" === n.mode ? (i[l](),
        ...
        toggle: (m = x.fn.toggle,
        function(t) {
            if (K(t) || "boolean" == typeof t)
    ...
    x.effects.define("bounce", function(t, e) {
        var i, n, s, o = x(this), r = t.mode, a = "hide" === r, l = "show" === r, h = t.direction || "up", c = t.distance, u = t.times || 5, d = 2 * u + (l || a ? 1 : 0), p = t.duration / d, f = t.easing, g = "up" === h || "down" === h ? "top" : "left", m = "up" === h || "left" === h, v = 0, _ = o.queue().length;
        for (x.effects.createPlaceholder(o),
        s = o.css(g),
        c = c || o["top" == g ? "outerHeight" : "outerWidth"]() / 3,
        l && ((n = {
            opacity: 1
        })[g] = s,
        o.css("opacity", 0).css(g, m ? 2 * -c : 2 * c).animate(n, p, f)),
        a && (c /= Math.pow(2, u - 1)),
        (n = {})[g] = s; v < u; v++)
            (i = {})[g] = (m ? "-=" : "+=") + c,
    ...
    x.effects.define("clip", "hide", function(t, e) {
        var i, n = {}, s = x(this), o = t.direction || "vertical", r = "both" === o, a = r || "horizontal" === o, l = r || "vertical" === o;
        i = s.cssClip(),
        n.clip = {
    ...
    x.effects.define("drop", "hide", function(t, e) {
        var i, n = x(this), s = "show" === t.mode, o = t.direction || "left", r = "up" === o || "down" === o ? "top" : "left", a = "up" === o || "left" === o ? "-=" : "+=", l = "+=" == a ? "-=" : "+=", h = {
            opacity: 0
        };
    ...
    x.effects.define("explode", "hide", function(t, e) {
        ...
        var n, s, o, r, a, l, h = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3, c = h, u = x(this), d = "show" === t.mode, p = u.show().css("visibility", "hidden").offset(), f = Math.ceil(u.outerWidth() / c), g = Math.ceil(u.outerHeight() / h), m = [];
        for (n = 0; n < h; n++)
            for (r = p.top + n * g,
            l = n - (h - 1) / 2,
            s = 0; s < c; s++)
    ...
    x.effects.define("fold", "hide", function(e, t) {
        ...
        p.clip = u),
        i.queue(function(t) {
            c && c.animate(x.effects.clipToBox(d), h, e.easing).animate(x.effects.clipToBox(p), h, e.easing),
            t()
    ...
    x.effects.define("size", function(s, e) {
        ...
        "box" !== u && "both" !== u || (o.from.y !== o.to.y && (m = x.effects.setTransition(n, a, o.from.y, m),
        v = x.effects.setTransition(n, a, o.to.y, v)),
        o.from.x !== o.to.x && (m = x.effects.setTransition(n, l, o.from.x, m),
        v = x.effects.setTransition(n, l, o.to.x, v))),
        "content" !== u && "both" !== u || o.from.y === o.to.y || (m = x.effects.setTransition(n, r, o.from.y, m),
        v = x.effects.setTransition(n, r, o.to.y, v)),
        d && (t = x.effects.getBaseline(d, g),
        ...
        n.css(m),
        "content" !== u && "both" !== u || (a = a.concat(["marginTop", "marginBottom"]).concat(r),
        ...
        n.find("*[width]").each(function() {
            ...
            o.from.y !== o.to.y && (i = x.effects.setTransition(t, a, o.from.y, i),
            n = x.effects.setTransition(t, a, o.to.y, n)),
            o.from.x !== o.to.x && (i = x.effects.setTransition(t, l, o.from.x, i),
        ...
        n.animate(v, {
            ...
            complete: function() {
                ...
                c || (n.css("position", "static" === p ? "relative" : p).offset(t),
    ...
    x.effects.define("shake", function(t, e) {
        ...
        d[h] = (c ? "+=" : "-=") + 2 * o,
        p[h] = (c ? "-=" : "+=") + 2 * o,
        n.animate(u, l, t.easing); i < r; i++)
            n.animate(d, l, t.easing).animate(p, l, t.easing);
        n.animate(d, l, t.easing).animate(u, l / 2, t.easing).queue(e),
    ...
    x.effects.define("slide", "show", function(t, e) {
        var i, n, s = x(this), o = {
            ...
            left: ["right", "left"],
            right: ["left", "right"]
        }, r = t.mode, a = t.direction || "left", l = "up" === a || "down" === a ? "top" : "left", h = "up" === a || "left" === a, c = t.distance || s["top" == l ? "outerHeight" : "outerWidth"](!0), u = {};
        x.effects.createPlaceholder(s),
        i = s.cssClip(),
        n = s.position()[l],
        u[l] = (h ? -1 : 1) * c + n,
    ...
    x.ui.focusable = function(t, e) {
        ...
        !(!t.href || !n || "map" !== i.nodeName.toLowerCase()) && (0 < (s = x("img[usemap='#" + n + "']")).length && s.is(":visible"))) : (/^(input|select|textarea|button|object)$/.test(a) ? (o = !t.disabled) && ((r = x(t).closest("fieldset")[0]) && (o = !r.disabled)) : o = "a" === a && t.href || e,
    ...
    x.fn.labels = function() {
        ...
        (i = this.attr("id")) && (s = (t = this.eq(0).parents().last()).add(t.length ? t.siblings() : this.siblings()),
    ...
    x.widget("ui.accordion", {
        ...
        _eventHandler: function(t) {
            var e, i, n = this.options, s = this.active, o = x(t.currentTarget), r = o[0] === s[0], a = r && n.collapsible, l = a ? x() : o.next(), h = s.next(), c = {
                oldHeader: s,
                oldPanel: h,
                newHeader: a ? x() : o,
                newPanel: l
            ...
            t.preventDefault(),
            r && !n.collapsible || !1 === this._trigger("beforeActivate", t, c) || (n.active = !a && this.headers.index(o),
            this.active = r ? x() : o,
            this._toggle(c),
            this._removeClass(s, "ui-accordion-header-active", "ui-state-active"),
            n.icons && (e = s.children(".ui-accordion-header-icon"),
            this._removeClass(e, null, n.icons.activeHeader)._addClass(e, null, n.icons.header)),
        ...
        _animate: function(t, i, e) {
            ...
            var s, o, r, a = this, l = 0, h = t.css("box-sizing"), c = t.length && (!i.length || t.index() < i.index()), u = this.options.animate || {}, d = c && u.down || u;
            ...
            void t.hide().animate(this.showProps, {
                ...
                step: function(t, e) {
                    e.now = Math.round(t),
                    "height" !== e.prop ? "content-box" === h && (l += e.now) : "content" !== a.options.heightStyle && (e.now = Math.round(s - i.outerHeight() - l),
                    l = 0)
                }
    ...
    x.widget("ui.menu", {
        ...
        refresh: function() {
            ...
            e = r.filter(":not(.ui-menu)").hide().attr({
                role: this.options.role,
                "aria-hidden": "true",
                "aria-expanded": "false"
            }).each(function() {
        ...
        _scrollIntoView: function(t) {
            var e, i, n, s, o, r;
            this._hasScroll() && (e = parseFloat(x.css(this.activeMenu[0], "borderTopWidth")) || 0,
        ...
        _create: function() {
            ...
            this._on(this.menu.element, {
                ...
                menufocus: function(t, e) {
                    ...
                    void ((i = e.item.attr("aria-label") || n.value) && x.trim(i).length && (this.liveRegion.children().hide(),
    ...
    x.widget("ui.controlgroup", {
        ...
        _initWidgets: function() {
            ...
            x.each(this.options.items, function(s, t) {
                ...
                void (a = a.concat(e.get()))) : void (x.fn[s] && (o = r["_" + s + "Options"] ? r["_" + s + "Options"]("middle") : {
                    classes: {}
                },
                r.element.find(t).each(function() {
                    ...
                    if ("button" !== s || !t.parent(".ui-spinner").length) {
                        (e = e || t[s]()[s]("instance")) && (i.classes = r._resolveClassesValues(i.classes, e)),
                        t[s](i);
                        var n = t[s]("widget");
                        x.data(n[0], "ui-controlgroup-data", e || t[s]("instance")),
                        a.push(n[0])
                    }
                }))) : void 0
            }),
        ...
        refresh: function() {
            ...
            s.length && (x.each(["first", "last"], function(t, e) {
    ...
    x.fn.button = (et = x.fn.button,
    function() {
        return !this.length || this.length && "INPUT" !== this[0].tagName || this.length && "INPUT" === this[0].tagName && "checkbox" !== this.attr("type") && "radio" !== this.attr("type") ? et.apply(this, arguments) : (x.ui.checkboxradio || x.error("Checkboxradio widget missing"),
    ...
    x.extend(t.prototype, {
        ...
        _attachments: function(t, e) {
            ...
            o && (e.append = x("<span class='" + this._appendClass + "'>" + o + "</span>"),
            ...
            e.trigger = x(this._get(e, "buttonImageOnly") ? x("<img/>").addClass(this._triggerClass).attr({
                src: s,
                alt: n,
                title: n
            ...
            e.trigger.on("click", function() {
                return x.datepicker._datepickerShowing && x.datepicker._lastInput === t[0] ? x.datepicker._hideDatepicker() : (x.datepicker._datepickerShowing && x.datepicker._lastInput !== t[0] && x.datepicker._hideDatepicker(),
        ...
        _optionDatepicker: function(t, e, i) {
            ...
            return 2 === arguments.length && "string" == typeof e ? "defaults" === e ? x.extend({}, x.datepicker._defaults) : a ? "all" === e ? x.extend({}, a.settings) : this._get(a, e) : null : (n = e || {},
            "string" == typeof e && ((n = {})[e] = i),
            void (a && (this._curInst === a && this._hideDatepicker(),
        ...
        _doKeyDown: function(t) {
            ...
            x.datepicker._datepickerShowing)
                ...
                case 9:
                    ...
                    break;
                case 13:
                    return (n = x("td." + x.datepicker._dayOverClass + ":not(." + x.datepicker._currentClass + ")", s.dpDiv))[0] && x.datepicker._selectDay(t.target, s.selectedMonth, s.selectedYear, n[0]),
                    (e = x.datepicker._get(s, "onSelect")) ? (i = x.datepicker._formatDate(s),
                    e.apply(s.input ? s.input[0] : null, [i, s])) : x.datepicker._hideDatepicker(),
                    !1;
                case 27:
                    x.datepicker._hideDatepicker();
                    break;
                ...
                case 37:
                    ...
                    break;
                case 38:
                    (t.ctrlKey || t.metaKey) && x.datepicker._adjustDate(t.target, -7, "D"),
                    o = t.ctrlKey || t.metaKey;
                    break;
                case 39:
                    (t.ctrlKey || t.metaKey) && x.datepicker._adjustDate(t.target, r ? -1 : 1, "D"),
                ...
                36 === t.keyCode && t.ctrlKey ? x.datepicker._showDatepicker(this) : o = !1;
            o && (t.preventDefault(),
            t.stopPropagation())
        },
        _doKeyPress: function(t) {
            var e, i, n = x.datepicker._getInst(t.target);
            return x.datepicker._get(n, "constrainInput") ? (e = x.datepicker._possibleChars(x.datepicker._get(n, "dateFormat")),
        ...
        _showDatepicker: function(t) {
            ...
            x.datepicker._isDisabledDatepicker(t) || x.datepicker._lastInput === t || (e = x.datepicker._getInst(t),
            x.datepicker._curInst && x.datepicker._curInst !== e && (x.datepicker._curInst.dpDiv.stop(!0, !0),
            e && x.datepicker._datepickerShowing && x.datepicker._hideDatepicker(x.datepicker._curInst.input[0])),
            !1 !== (n = (i = x.datepicker._get(e, "beforeShow")) ? i.apply(t, [t, e]) : {}) && (u(e.settings, n),
            e.lastVal = null,
            x.datepicker._lastInput = t,
            x.datepicker._setDateFromField(e),
            x.datepicker._inDialog && (t.value = ""),
            x.datepicker._pos || (x.datepicker._pos = x.datepicker._findPos(t),
            x.datepicker._pos[1] += t.offsetHeight),
            s = !1,
            x(t).parents().each(function() {
            ...
            e.inline || (r = x.datepicker._get(e, "showAnim"),
        ...
        _findPos: function(t) {
            for (var e, i = this._getInst(t), n = this._get(i, "isRTL"); t && ("hidden" === t.type || 1 !== t.nodeType || x.expr.filters.hidden(t)); )
                t = t[n ? "previousSibling" : "nextSibling"];
            return [(e = x(t).offset()).left, e.top]
        },
        _hideDatepicker: function(t) {
            var e, i, n, s, o = this._curInst;
            !o || t && o !== x.data(t, "datepicker") || this._datepickerShowing && (e = this._get(o, "showAnim"),
        ...
        _selectDay: function(t, e, i, n) {
            var s, o = x(t);
            x(n).hasClass(this._unselectableClass) || this._isDisabledDatepicker(o[0]) || ((s = this._getInst(o[0])).selectedDay = s.currentDay = x("a", n).html(),
        ...
        parseDate: function(i, o, t) {
            ...
            function n(t, e, i) {
                ...
                if (x.each(s, function(t, e) {
                    var i = e[1];
                    return o.substr(u, i.length).toLowerCase() === i.toLowerCase() ? (n = e[0],
                    u += i.length,
                    !1) : void 0
                }),
                -1 !== n)
            ...
            var a, l, h, c, u = 0, d = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff, p = "string" != typeof d ? d : (new Date).getFullYear() % 100 + parseInt(d, 10), f = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, g = (t ? t.dayNames : null) || this._defaults.dayNames, m = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, v = (t ? t.monthNames : null) || this._defaults.monthNames, _ = -1, b = -1, y = -1, w = -1, C = !1;
            for (a = 0; i.length > a; a++)
                if (C)
                    ...
                    case "@":
                        ...
                        break;
                    case "!":
                        _ = (c = new Date((e("!") - this._ticksTo1970) / 1e4)).getFullYear(),
                        b = c.getMonth() + 1,
                        y = c.getDate();
                        break;
                    case "'":
            ...
            if (o.length > u && (h = o.substr(u),
            !/^\s+/.test(h)))
                throw "Extra/unparsed characters found in date: " + h;
            if (-1 === _ ? _ = (new Date).getFullYear() : _ < 100 && (_ += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (_ <= p ? 0 : -100)),
            -1 < w)
                for (b = 1,
                y = w; !(y <= (l = this._getDaysInMonth(_, b - 1))); )
                    b++,
                    y -= l;
            if ((c = this._daylightSavingAdjust(new Date(_,b - 1,y))).getFullYear() !== _ || c.getMonth() + 1 !== b || c.getDate() !== y)
                throw "Invalid date";
            return c
        },
        ATOM: "yy-mm-dd",
        ...
        formatDate: function(i, t, e) {
            ...
            var r, a = (e ? e.dayNamesShort : null) || this._defaults.dayNamesShort, l = (e ? e.dayNames : null) || this._defaults.dayNames, h = (e ? e.monthNamesShort : null) || this._defaults.monthNamesShort, c = (e ? e.monthNames : null) || this._defaults.monthNames, u = "", d = !1;
            if (t)
        ...
        _determineDate: function(a, t, e) {
            var i, n, s = null == t || "" === t ? e : "string" == typeof t ? function(t) {
                ...
                for (var e = (t.toLowerCase().match(/^c/) ? x.datepicker._getDate(a) : null) || new Date, i = e.getFullYear(), n = e.getMonth(), s = e.getDate(), o = /([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, r = o.exec(t); r; ) {
                    ...
                    case "M":
                        n += parseInt(r[1], 10),
                        s = Math.min(s, x.datepicker._getDaysInMonth(i, n));
                        break;
                    case "y":
                    case "Y":
                        i += parseInt(r[1], 10),
            ...
            return (s = s && "Invalid Date" == "" + s ? e : s) && (s.setHours(0),
            s.setMinutes(0),
            s.setSeconds(0),
            s.setMilliseconds(0)),
        ...
        _generateHTML: function(t) {
            ...
            n = this._canAdjustMonth(t, -1, tt, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (z ? "e" : "w") + "'>" + i + "</span></a>" : B ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (z ? "e" : "w") + "'>" + i + "</span></a>",
            s = this._get(t, "nextText"),
            s = U ? this.formatDate(s, this._daylightSavingAdjust(new Date(tt,Z + V,1)), this._getFormatConfig(t)) : s,
            o = this._canAdjustMonth(t, 1, tt, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (z ? "w" : "e") + "'>" + s + "</span></a>" : B ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (z ? "w" : "e") + "'>" + s + "</span></a>",
            ...
            h = q ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (z ? l : "") + (this._isInRange(t, a) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + r + "</button>" : "") + (z ? "" : l) + "</div>" : "",
            ...
            C = 0; Y[0] > C; C++) {
                ...
                k = 0; Y[1] > k; k++) {
                    ...
                    X) {
                        ...
                        1 < Y[1])
                            ...
                            case 0:
                                ...
                                D = " ui-corner-" + (z ? "right" : "left");
                                break;
                            case Y[1] - 1:
                                S += " ui-datepicker-group-last",
                                D = " ui-corner-" + (z ? "left" : "right");
                                break;
                            default:
                    ...
                    for (S += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + D + "'>" + (/all|left/.test(D) && 0 === C ? z ? o : n : "") + (/all|right/.test(D) && 0 === C ? z ? n : o : "") + this._generateMonthYearHeader(t, Z, tt, G, J, 0 < C || 0 < k, f, g) + "</div><table class='ui-datepicker-calendar'><thead><tr>",
                    ...
                    $ = 0; $ < O; $++) {
                        for (S += "<tr>",
                        H = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(M) + "</td>" : "",
                        w = 0; w < 7; w++)
                            L = m ? m.apply(t.input ? t.input[0] : null, [M]) : [!0, ""],
                            R = (W = M.getMonth() !== Z) && !_ || !L[0] || G && M < G || J && J < M,
                            H += "<td class='" + (5 <= (w + c + 6) % 7 ? " ui-datepicker-week-end" : "") + (W ? " ui-datepicker-other-month" : "") + (M.getTime() === T.getTime() && Z === t.selectedMonth && t._keyEvent || b.getTime() === M.getTime() && b.getTime() === T.getTime() ? " " + this._dayOverClass : "") + (R ? " " + this._unselectableClass + " ui-state-disabled" : "") + (W && !v ? "" : " " + L[1] + (M.getTime() === Q.getTime() ? " " + this._currentClass : "") + (M.getTime() === j.getTime() ? " ui-datepicker-today" : "")) + "'" + (W && !v || !L[2] ? "" : " title='" + L[2].replace(/'/g, "&#39;") + "'") + (R ? "" : " data-handler='selectDay' data-event='click' data-month='" + M.getMonth() + "' data-year='" + M.getFullYear() + "'") + ">" + (W && !v ? "&#xa0;" : R ? "<span class='ui-state-default'>" + M.getDate() + "</span>" : "<a class='ui-state-default" + (M.getTime() === j.getTime() ? " ui-state-highlight" : "") + (M.getTime() === Q.getTime() ? " ui-state-active" : "") + (W ? " ui-priority-secondary" : "") + "' href='#'>" + M.getDate() + "</a>") + "</td>",
                    ...
                    11 < ++Z && (Z = 0,
                    tt++),
                    x += S += "</tbody></table>" + (X ? "</div>" + (0 < Y[0] && k === Y[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                }
                y += x
            }
            return y += h,
    ...
    x.widget("ui.mouse", {
        ...
        _mouseInit: function() {
            ...
            this.element.on("mousedown." + this.widgetName, function(t) {
                ...
                return !0 === x.data(t.target, e.widgetName + ".preventClickEvent") ? (x.removeData(t.target, e.widgetName + ".preventClickEvent"),
                t.stopImmediatePropagation(),
                !1) : void 0
            }),
            this.started = !1
        ...
        _mouseDown: function(t) {
            if (!st) {
                ...
                !this._mouseStarted) ? t.preventDefault() : (!0 === x.data(t.target, this.widgetName + ".preventClickEvent") && x.removeData(t.target, this.widgetName + ".preventClickEvent"),
    ...
    x.widget("ui.draggable", x.ui.mouse, {
        ...
        _mouseStop: function(t) {
            ...
            this.dropped = !1),
            "invalid" === this.options.revert && !i || "valid" === this.options.revert && i || !0 === this.options.revert || x.isFunction(this.options.revert) && this.options.revert.call(this.element, i) ? x(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function() {
        ...
        _setContainment: function() {
            ...
            void ((i = (e = x(n.containment))[0]) && (t = /(scroll|auto)/.test(e.css("overflow")),
        ...
        _generatePosition: function(t, e) {
            ...
            e && (this.containment && (i = this.relativeContainer ? (n = this.relativeContainer.offset(),
            [this.containment[0] + n.left, this.containment[1] + n.top, this.containment[2] + n.left, this.containment[3] + n.top]) : this.containment,
    ...
    x.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(t, e, i) {
            var n = i.options
              ...
              , r = i.document[0];
            o !== r && "HTML" !== o.tagName ? (n.axis && "x" === n.axis || (i.overflowOffset.top + o.offsetHeight - t.pageY < n.scrollSensitivity ? o.scrollTop = s = o.scrollTop + n.scrollSpeed : t.pageY - i.overflowOffset.top < n.scrollSensitivity && (o.scrollTop = s = o.scrollTop - n.scrollSpeed)),
            n.axis && "y" === n.axis || (i.overflowOffset.left + o.offsetWidth - t.pageX < n.scrollSensitivity ? o.scrollLeft = s = o.scrollLeft + n.scrollSpeed : t.pageX - i.overflowOffset.left < n.scrollSensitivity && (o.scrollLeft = s = o.scrollLeft - n.scrollSpeed))) : (n.axis && "x" === n.axis || (t.pageY - x(r).scrollTop() < n.scrollSensitivity ? s = x(r).scrollTop(x(r).scrollTop() - n.scrollSpeed) : x(window).height() - (t.pageY - x(r).scrollTop()) < n.scrollSensitivity && (s = x(r).scrollTop(x(r).scrollTop() + n.scrollSpeed))),
            n.axis && "y" === n.axis || (t.pageX - x(r).scrollLeft() < n.scrollSensitivity ? s = x(r).scrollLeft(x(r).scrollLeft() - n.scrollSpeed) : x(window).width() - (t.pageX - x(r).scrollLeft()) < n.scrollSensitivity && (s = x(r).scrollLeft(x(r).scrollLeft() + n.scrollSpeed)))),
    ...
    x.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(t, e, i) {
            var n, s, o, r, a, l, h, c, u, d, p = i.options, f = p.snapTolerance, g = e.offset.left, m = g + i.helperProportions.width, v = e.offset.top, _ = v + i.helperProportions.height;
            for (u = i.snapElements.length - 1; 0 <= u; u--)
                ...
                m < a - f || l + f < g || _ < h - f || c + f < v || !x.contains(i.snapElements[u].item.ownerDocument, i.snapElements[u].item) ? (i.snapElements[u].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, x.extend(i._uiHash(), {
                    snapItem: i.snapElements[u].item
                })),
                i.snapElements[u].snapping = !1) : ("inner" !== p.snapMode && (n = f >= Math.abs(h - _),
                s = f >= Math.abs(c - v),
                o = f >= Math.abs(a - m),
                r = f >= Math.abs(l - g),
                ...
                d = n || s || o || r,
                "outer" !== p.snapMode && (n = f >= Math.abs(h - v),
                s = f >= Math.abs(c - _),
                o = f >= Math.abs(a - g),
                r = f >= Math.abs(l - m),
                n && (e.position.top = i._convertPositionTo("relative", {
                ...
                !i.snapElements[u].snapping && (n || s || o || r || d) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, x.extend(i._uiHash(), {
                    snapItem: i.snapElements[u].item
                })),
    ...
    x.ui.plugin.add("draggable", "stack", {
        start: function(t, e, i) {
            ...
            o.length && (n = parseInt(x(o[0]).css("zIndex"), 10) || 0,
            x(o).each(function(t) {
    ...
    x.widget("ui.resizable", x.ui.mouse, {
        ...
        _mouseCapture: function(t) {
            ...
            for (e in this.handles)
                (i = x(this.handles[e])[0]) !== t.target && !x.contains(i, t.target) || (n = !0);
        ...
        _mouseDrag: function(t) {
            var e, i, n = this.originalMousePosition, s = this.axis, o = t.pageX - n.left || 0, r = t.pageY - n.top || 0, a = this._change[s];
            return this._updatePrevProperties(),
            a && (e = a.apply(this, [t, o, r]),
            ...
            x.isEmptyObject(i) || (this._updatePrevProperties(),
        ...
        _mouseStop: function(t) {
            ...
            return this._helper && (n = (i = (e = this._proportionallyResizeElements).length && /textarea/i.test(e[0].nodeName)) && this._hasScroll(e[0], "left") ? 0 : h.sizeDiff.height,
            ...
            l.animate || this.element.css(x.extend(o, {
                top: a,
                left: r
            })),
        ...
        _renderProxy: function() {
            ...
            this._helper ? (this.helper = this.helper || x("<div style='overflow:hidden;'></div>"),
    ...
    x.ui.plugin.add("resizable", "containment", {
        start: function() {
            var i, n, t, e, s, o, r, a = x(this).resizable("instance"), l = a.options, h = a.element, c = l.containment, u = c instanceof x ? c.get(0) : /parent/.test(c) ? h.parent().get(0) : c;
            u && (a.containerElement = x(u),
        ...
        resize: function(t) {
            var e, i, n, s, o = x(this).resizable("instance"), r = o.options, a = o.containerOffset, l = o.position, h = o._aspectRatio || t.shiftKey, c = {
                top: 0,
                left: 0
            }, u = o.containerElement, d = !0;
            ...
            n && s ? (o.offset.left = o.parentData.left + o.position.left,
            ...
            h && (o.size.width = o.size.height * o.aspectRatio,
            d = !1)),
            d || (o.position.left = o.prevPosition.left,
    ...
    x.ui.plugin.add("resizable", "grid", {
        resize: function() {
            var t, e = x(this).resizable("instance"), i = e.options, n = e.size, s = e.originalSize, o = e.originalPosition, r = e.axis, a = "number" == typeof i.grid ? [i.grid, i.grid] : i.grid, l = a[0] || 1, h = a[1] || 1, c = Math.round((n.width - s.width) / l) * l, u = Math.round((n.height - s.height) / h) * h, d = s.width + c, p = s.height + u, f = i.maxWidth && d > i.maxWidth, g = i.maxHeight && p > i.maxHeight, m = i.minWidth && i.minWidth > d, v = i.minHeight && i.minHeight > p;
            i.grid = a,
            m && (d += l),
            v && (p += h),
            f && (d -= l),
            g && (p -= h),
            /^(se|s|e)$/.test(r) ? (e.size.width = d,
            e.size.height = p) : /^(ne)$/.test(r) ? (e.size.width = d,
            e.size.height = p,
            e.position.top = o.top - u) : /^(sw)$/.test(r) ? (e.size.width = d,
            e.size.height = p,
    ...
    x.widget("ui.dialog", {
        ...
        _createButtons: function() {
            ...
            x.isEmptyObject(t) || x.isArray(t) && !t.length ? void this._removeClass(this.uiDialog, "ui-dialog-buttons") : (x.each(t, function(t, e) {
                var i, n;
                e = x.isFunction(e) ? {
                    click: e,
                    text: t
                ...
                x("<button></button>", e).button(n).appendTo(s.uiButtonSet).on("click", function() {
    ...
    x.widget("ui.droppable", {
        ...
        _create: function() {
            ...
            this.isover = !1,
            this.isout = !0,
            this.accept = x.isFunction(i) ? i : function(t) {
                return t.is(i)
            }
            ,
        ...
        _setOption: function(t, e) {
            if ("accept" === t)
                this.accept = x.isFunction(e) ? e : function(t) {
                    return t.is(e)
                }
                ;
            else if ("scope" === t) {
    ...
    !(x.ui.ddmanager = {
        ...
        prepareOffsets: function(t, e) {
            var i, n, s = x.ui.ddmanager.droppables[t.options.scope] || [], o = e ? e.type : null, r = (t.currentItem || t.element).find(":data(ui-droppable)").addBack();
        ...
        drop: function(t, e) {
            ...
            return x.each((x.ui.ddmanager.droppables[t.options.scope] || []).slice(), function() {
                this.options && (!this.options.disabled && this.visible && rt(t, this, this.options.tolerance, e) && (i = this._drop.call(this, e) || i),
        ...
        drag: function(o, r) {
            ...
            x.each(x.ui.ddmanager.droppables[o.options.scope] || [], function() {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var t, e, i, n = rt(o, this, this.options.tolerance, r), s = !n && this.isover ? "isout" : n && !this.isover ? "isover" : null;
    ...
    x.widget("ui.sortable", x.ui.mouse, {
        ...
        _mouseCapture: function(t, e) {
            ...
            x(t.target).parents().each(function() {
                return x.data(this, s.widgetName + "-item") === s ? (i = x(this),
                !1) : void 0
            }),
            x.data(t.target, s.widgetName + "-item") === s && (i = x(t.target)),
            !!i && (!(this.options.handle && !e && (x(this.options.handle, i).find("*").addBack().each(function() {
                this === t.target && (n = !0)
            }),
        ...
        _mouseStart: function(t, e, i) {
            ...
            this.storedStylesheet = x("<style>*{ cursor: " + o.cursor + " !important; }</style>").appendTo(s)),
        ...
        _mouseDrag: function(t) {
            ...
            e = this.items.length - 1; 0 <= e; e--)
                ...
                (s = this._intersectsWithPointer(i)) && i.instance === this.currentContainer && n !== this.currentItem[0] && this.placeholder[1 === s ? "next" : "prev"]()[0] !== n && !x.contains(this.placeholder[0], n) && ("semi-dynamic" !== this.options.type || !x.contains(this.element[0], n))) {
        ...
        _mouseStop: function(t, e) {
            if (t) {
                if (x.ui.ddmanager && !this.options.dropBehaviour && x.ui.ddmanager.drop(this, t),
                this.options.revert) {
                    var i = this
            ...
            if (l && t)
                for (i = l.length - 1; 0 <= i; i--)
                    for (n = (s = x(l[i], this.document[0])).length - 1; 0 <= n; n--)
                        (o = x.data(s[n], this.widgetFullName)) && o !== this && !o.options.disabled && a.push([x.isFunction(o.options.items) ? o.options.items.call(o.element) : x(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
        ...
        _refreshItems: function(t) {
            ...
            var e, i, n, s, o, r, a, l, h = this.items, c = [[x.isFunction(this.options.items) ? this.options.items.call(this.element[0], t, {
                item: this.currentItem
            }) : x(this.options.items, this.element), this]], u = this._connectWith();
            if (u && this.ready)
                for (e = u.length - 1; 0 <= e; e--)
                    for (i = (n = x(u[e], this.document[0])).length - 1; 0 <= i; i--)
                        (s = x.data(n[i], this.widgetFullName)) && s !== this && !s.options.disabled && (c.push([x.isFunction(s.options.items) ? s.options.items.call(s.element[0], t, {
                            item: this.currentItem
                        }) : x(s.options.items, s.element), s]),
        ...
        refreshPositions: function(t) {
            ...
            e = this.items.length - 1; 0 <= e; e--)
                (i = this.items[e]).instance !== this.currentContainer && this.currentContainer && i.item[0] !== this.currentItem[0] || (n = this.options.toleranceElement ? x(this.options.toleranceElement, i.item) : i.item,
        ...
        _createPlaceholder: function(i) {
            ...
            s.placeholder = {
                element: function() {
                    ...
                    "tbody" === t ? i._createTrPlaceholder(i.currentItem.find("tr").eq(0), x("<tr>", i.document[0]).appendTo(e)) : "tr" === t ? i._createTrPlaceholder(i.currentItem, e) : "img" === t && e.attr("src", i.currentItem.attr("src")),
            ...
            if (u)
                if (1 === this.containers.length)
                    ...
                    i = this.items.length - 1; 0 <= i; i--)
                        x.contains(this.containers[d].element[0], this.items[i].item[0]) && this.items[i].item[0] !== this.currentItem[0] && (a = this.items[i].item.offset()[o],
                        l = !1,
                        t[c] - a > this.items[i][r] / 2 && (l = !0),
                        n > Math.abs(t[c] - a) && (n = Math.abs(t[c] - a),
                        s = this.items[i],
                        this.direction = l ? "up" : "down"));
                    if (!s && !this.options.dropOnEmpty)
                        return;
                    if (this.currentContainer === this.containers[d])
                        return void (this.currentContainer.containerCache.over || (this.containers[d]._trigger("over", t, this._uiHash()),
        ...
        _createHelper: function(t) {
            ...
            return i.parents("body").length || x("parent" !== e.appendTo ? e.appendTo : this.currentItem[0].parentNode)[0].appendChild(i[0]),
        ...
        _getParentOffset: function() {
            this.offsetParent = this.helper.offsetParent();
            var t = this.offsetParent.offset();
            return "absolute" === this.cssPosition && this.scrollParent[0] !== this.document[0] && x.contains(this.scrollParent[0], this.offsetParent[0]) && (t.left += this.scrollParent.scrollLeft(),
            t.top += this.scrollParent.scrollTop()),
            (this.offsetParent[0] === this.document[0].body || this.offsetParent[0].tagName && "html" === this.offsetParent[0].tagName.toLowerCase() && x.ui.ie) && (t = {
                top: 0,
                left: 0
            }),
            {
        ...
        _setContainment: function() {
            ...
            /^(document|window|parent)$/.test(n.containment) || (t = x(n.containment)[0],
        ...
        _generatePosition: function(t) {
            var e, i, n = this.options, s = t.pageX, o = t.pageY, r = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && x.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent, a = /(html|body)/i.test(r[0].tagName);
    ...
    x.widget("ui.tabs", {
        ...
        _create: function() {
            ...
            x.isArray(t.disabled) && (t.disabled = x.unique(t.disabled.concat(x.map(this.tabs.filter(".ui-state-disabled"), function(t) {
        ...
        _initialActive: function() {
            ...
            return null === i && (n && this.tabs.each(function(t, e) {
                return x(e).attr("aria-controls") === n ? (i = t,
                !1) : void 0
            }),
        ...
        _panelKeydown: function(t) {
            this._handlePageNav(t) || t.ctrlKey && t.keyCode === x.ui.keyCode.UP && (t.preventDefault(),
            this.active.trigger("focus"))
        },
        _handlePageNav: function(t) {
            return t.altKey && t.keyCode === x.ui.keyCode.PAGE_UP ? (this._activate(this._focusNextTab(this.options.active - 1, !1)),
            !0) : t.altKey && t.keyCode === x.ui.keyCode.PAGE_DOWN ? (this._activate(this._focusNextTab(this.options.active + 1, !0)),
            !0) : void 0
        },
        _findNextTab: function(t, e) {
            for (var i = this.tabs.length - 1; -1 !== x.inArray((i < t && (t = 0),
            t < 0 && (t = i),
        ...
        refresh: function() {
            ...
            this._processTabs(),
            !1 !== t.active && this.anchors.length ? this.active.length && !x.contains(this.tablist[0], this.active[0]) ? this.tabs.length === t.disabled.length ? (t.active = !1,
            this.active = x()) : this._activate(this._findNextTab(Math.max(0, t.active - 1), !1)) : t.active = this.tabs.index(this.active) : (t.active = !1,
            this.active = x()),
            this._refresh()
        },
        _refresh: function() {
        ...
        _processTabs: function() {
            ...
            this.anchors.each(function(t, e) {
                ...
                n = l.element.find(l._sanitizeSelector(i))) : (i = "#" + (s = r.attr("aria-controls") || x({}).uniqueId()[0].id),
        ...
        _setOptionDisabled: function(t) {
            var e, i, n;
            for (x.isArray(t) && (t.length ? t.length === this.anchors.length && (t = !0) : t = !1),
            n = 0; i = this.tabs[n]; n++)
                e = x(i),
                !0 === t || -1 !== x.inArray(n, t) ? (e.attr("aria-disabled", "true"),
        ...
        _getIndex: function(t) {
            return "string" == typeof t && (t = this.anchors.index(this.anchors.filter("[href$='" + x.ui.escapeSelector(t) + "']"))),
            t
        },
        _destroy: function() {
            this.xhr && this.xhr.abort(),
        ...
        enable: function(i) {
            ...
            x.isArray(t) ? x.map(t, function(t) {
                return t !== i ? t : null
        ...
        load: function(t, n) {
            ...
            this._isLocal(e[0]) || (this.xhr = x.ajax(this._ajaxSettings(e, n, a)),
    ...
    x.widget("ui.tooltip", {
        ...
        _addDescribedBy: function(t, e) {
            ...
            i.push(e),
            t.data("ui-tooltip-id", e).attr("aria-describedby", x.trim(i.join(" ")))
        },
        _removeDescribedBy: function(t) {
            ...
            (i = x.trim(i.join(" "))) ? t.attr("aria-describedby", i) : t.removeAttr("aria-describedby")
        },
        _create: function() {
            this._on({
                mouseover: "open",
        ...
        _setOption: function(t, e) {
            var i = this;
            this._super(t, e),
            "content" === t && x.each(this.tooltips, function(t, e) {
        ...
        open: function(t) {
            ...
            t && "mouseover" === t.type && e.parents().each(function() {
                var t, e = x(this);
                e.data("ui-tooltip-open") && ((t = x.Event("blur")).target = t.currentTarget = this,
                i.close(t, !0)),
        ...
        _updateContent: function(e, i) {
            ...
            return "string" == typeof n || n.nodeType || n.jquery ? this._open(i, e, n) : void ((t = n.call(e[0], function(t) {
                s._delay(function() {
                    e.data("ui-tooltip-open") && (i && (i.type = o),
                    this._open(i, e, t))
                })
            })) && this._open(i, e, t))
        },
        ...
        close: function(t) {
            ...
            t && "mouseleave" === t.type && x.each(this.parents, function(t, e) {
                x(e.element).attr("title", e.title),
                delete i.parents[t]
            }),
            s.closing = !0,
            this._trigger("close", t, {
...
function(t, e) {
    ...
    var i, s = "alert", a = "bs.alert", l = "." + a, h = f.fn[s], c = {
        CLOSE: "close" + l,
        CLOSED: "closed" + l,
        CLICK_DATA_API: "click" + l + ".data-api"
    }, u = ((i = d.prototype).close = function(t) {
        var e = this._element;
    ...
    i._triggerCloseEvent = function(t) {
        ...
        return f(t).trigger(e),
        e
    }
    ,
    i._removeElement = function(e) {
        var i = this;
        if (f(e).removeClass("show"),
        f(e).hasClass("fade")) {
    ...
    ;
    var p, m = "button", v = "bs.button", _ = "." + v, b = ".data-api", y = f.fn[m], w = "active", C = '[data-toggle^="button"]', x = {
        CLICK_DATA_API: "click" + _ + b,
        FOCUS_BLUR_DATA_API: "focus" + _ + b + " blur" + _ + b
    }, k = ((p = T.prototype).toggle = function() {
        var t = !0
          , e = !0
        ...
        if (i) {
            ...
            if (n) {
                if ("radio" === n.type)
                    if (n.checked && this._element.classList.contains(w))
                        t = !1;
                    else {
        ...
        t && f(this._element).toggleClass(w)
    }
    ,
    p.dispose = function() {
    ...
    f(document).on(x.CLICK_DATA_API, C, function(t) {
        t.preventDefault();
        var e = t.target;
        f(e).hasClass("btn") || (e = f(e).closest(".btn")),
        k._jQueryInterface.call(f(e), "toggle")
    ...
    ;
    var D, S = "carousel", E = "bs.carousel", I = "." + E, A = f.fn[S], P = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
    ...
    }, H = "active", L = ".active.carousel-item", W = {
        TOUCH: "touch",
        PEN: "pen"
    }, R = ((D = F.prototype).next = function() {
    ...
    D._addEventListeners = function() {
        var e = this;
        this._config.keyboard && f(this._element).on($.KEYDOWN, function(t) {
            return e._keydown(t)
        }),
        "hover" === this._config.pause && f(this._element).on($.MOUSEENTER, function(t) {
            return e.pause(t)
    ...
    D._addTouchEventListeners = function() {
        ...
        if (this._touchSupported) {
            ...
            this._pointerEvent ? (f(this._element).on($.POINTERDOWN, function(t) {
                return e(t)
            }),
            f(this._element).on($.POINTERUP, function(t) {
                return n(t)
            }),
            this._element.classList.add("pointer-event")) : (f(this._element).on($.TOUCHSTART, function(t) {
                return e(t)
            }),
    ...
    D._slide = function(t, e) {
        var i, n, s, o = this, r = this._element.querySelector(L), a = this._getItemIndex(r), l = e || r && this._getItemByDirection(t, r), h = this._getItemIndex(l), c = Boolean(this._interval);
        if (s = t === O ? (i = "carousel-item-left",
        ...
        l && f(l).hasClass(H))
            ...
            if (f(this._element).hasClass("slide")) {
                ...
                f(r).one(g.TRANSITION_END, function() {
                    f(l).removeClass(i + " " + n).addClass(H),
    ...
    ;
    var j, z = "collapse", q = "bs.collapse", B = "." + q, U = f.fn[z], Y = {
        toggle: !0,
        parent: ""
    }, K = {
        toggle: "boolean",
    ...
    }, X = "show", Q = "collapse", G = "collapsing", J = "collapsed", Z = '[data-toggle="collapse"]', tt = ((j = et.prototype).toggle = function() {
        f(this._element).hasClass(X) ? this.hide() : this.show()
    }
    ,
    j.show = function() {
        var t, e, i = this;
        if (!(this._isTransitioning || f(this._element).hasClass(X) || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
        ...
        t && (e = f(t).not(this._selector).data(q)) && e._isTransitioning))) {
            ...
            !n.isDefaultPrevented()) {
                t && (et._jQueryInterface.call(f(t).not(this._selector), "hide"),
                e || f(t).data(q, null));
                var s = this._getDimension();
                f(this._element).removeClass(Q).addClass(G),
                ...
                f(this._element).one(g.TRANSITION_END, function() {
                    f(i._element).removeClass(G).addClass(Q).addClass(X),
                    i._element.style[s] = "",
                    i.setTransitioning(!1),
                    f(i._element).trigger(V.SHOWN)
    ...
    j.hide = function() {
        ...
        if (!this._isTransitioning && f(this._element).hasClass(X)) {
            ...
            if (f(this._element).trigger(e),
            !e.isDefaultPrevented()) {
                var i = this._getDimension();
                this._element.style[i] = this._element.getBoundingClientRect()[i] + "px",
                g.reflow(this._element),
                f(this._element).addClass(G).removeClass(Q).removeClass(X);
                ...
                f(this._element).one(g.TRANSITION_END, function() {
                    ...
                    f(t._element).removeClass(G).addClass(Q).trigger(V.HIDDEN)
    ...
    var rt = it && window.Promise ? function(t) {
        var e = !1;
        return function() {
            e || (e = !0,
    ...
    function ft(t) {
        ...
        for (var e = pt(10) ? document.body : null, i = t.offsetParent || null; i === e && t.nextElementSibling; )
    ...
    function mt(t, e) {
        ...
        if (t !== l && e !== l || n.contains(s))
            return "BODY" === (a = (r = l).nodeName) || "HTML" !== a && ft(r.firstElementChild) !== r ? ft(l) : l;
        var h = gt(t);
    ...
    function bt(t, e, i, n) {
        return Math.max(e["offset" + t], e["scroll" + t], i["client" + t], i["offset" + t], i["scroll" + t], pt(10) ? parseInt(i["offset" + t]) + parseInt(n["margin" + ("Height" === t ? "Top" : "Left")]) + parseInt(n["margin" + ("Height" === t ? "Bottom" : "Right")]) : 0)
    }
    function yt(t) {
        var e = t.body
          , i = t.documentElement
        ...
        return {
            height: bt("Height", e, i, n),
            width: bt("Width", e, i, n)
        }
    }
    function wt(t, e, i) {
    ...
    function Ht(t, i, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, i) {
            ...
            t.enabled && at(e) && (i.offsets.popper = Tt(i.offsets.popper),
            i.offsets.reference = Tt(i.offsets.reference),
            i = e(i, t))
        }),
        i
    }
    ...
    function jt(i, n) {
        Object.keys(n).forEach(function(t) {
            var e = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && Ft(n[t]) && (e = "px"),
            i.style[t] = n[t] + e
        })
    }
        ...
        modifiers: {
            ...
            offset: {
                ...
                fn: function(t, e) {
                    ...
                    return i = Ft(+n) ? [+n, 0] : function(t, s, o, e) {
                        var r = [0, 0]
                            ...
                            return t.reduce(function(t, e) {
                                ...
                                return function(t, e, i, n) {
                                    ...
                                    if (!o)
                                        return t;
                                    if (0 !== r.indexOf("%"))
                                        return "vh" !== r && "vw" !== r ? o : ("vh" === r ? Math.max(document.documentElement.clientHeight, window.innerHeight || 0) : Math.max(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * o;
                                    var a = void 0;
                                    switch (r) {
                                    case "%p":
                                        a = i;
                ...
                fn: function(t, n) {
                    ...
                    var h = n.priority
                      ...
                      , u = {
                        primary: function(t) {
                            var e = c[t];
                            return c[t] < l[t] && !n.escapeWithReference && (e = Math.max(c[t], l[t])),
                            wt({}, t, e)
                        },
                        secondary: function(t) {
                            var e = "right" === t ? "left" : "top"
                              , i = c[e];
                            return c[t] > l[t] && !n.escapeWithReference && (i = Math.min(c[e], l[t] - ("right" === t ? c.width : c.height))),
                            wt({}, e, i)
                        }
                    };
            ...
            arrow: {
                ...
                fn: function(t, e) {
                    ...
                    return b = Math.max(Math.min(r[h] - f, b), 0),
                    t.arrowElement = n,
                    t.offsets.arrow = (wt(i = {}, u, Math.round(b)),
                    wt(i, d, ""),
                    i),
                    t
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(f, g) {
                    if (Lt(f.instance.modifiers, "inner"))
                        return f;
                    ...
                    return y.forEach(function(t, e) {
                        ...
                        v = f.placement.split("-")[0],
                        _ = Ot(v);
                        var i, n = f.offsets.popper, s = f.offsets.reference, o = Math.floor, r = "left" === v && o(n.right) > o(s.left) || "right" === v && o(n.left) < o(s.right) || "top" === v && o(n.bottom) > o(s.top) || "bottom" === v && o(n.top) < o(s.bottom), a = o(n.left) < o(m.left), l = o(n.right) > o(m.right), h = o(n.top) < o(m.top), c = o(n.bottom) > o(m.bottom), u = "left" === v && a || "right" === v && l || "top" === v && h || "bottom" === v && c, d = -1 !== ["top", "bottom"].indexOf(v), p = !!g.flipVariations && (d && "start" === b && a || d && "end" === b && l || !d && "start" === b && h || !d && "end" === b && c);
                        (r || u || p) && (f.flipped = !0,
                        (r || u) && (v = y[e + 1]),
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var r, a, l, h, c, u, d, p, f, g, m, v, _, b, y, w, C = void 0 !== o ? o : e.gpuAcceleration, x = ft(t.instance.popper), k = Dt(x), T = {
                        position: s.position
                    }, D = (r = t,
                    ...
                    b = a ? u : p,
                    {
                        left: (_ = a ? m || v || f % 2 == g % 2 ? u : d : p)(f % 2 == 1 && g % 2 == 1 && !v && a ? h.left - 1 : h.left),
                        top: b(h.top),
                        bottom: b(h.bottom),
                        right: _(h.right)
                    }), S = "bottom" === i ? "top" : "bottom", E = "right" === n ? "left" : "right", I = Wt("transform");
                    if (w = "bottom" == S ? "HTML" === x.nodeName ? -x.clientHeight + D.bottom : -k.height + D.bottom : D.top,
                    y = "right" == E ? "HTML" === x.nodeName ? -x.clientWidth + D.right : -k.width + D.right : D.left,
                    C && I)
                        T[I] = "translate3d(" + y + "px, " + w + "px, 0)",
                        T[S] = 0,
                        T[E] = 0,
                    ...
                    return t.attributes = xt({}, N, t.attributes),
                    t.styles = xt({}, T, t.styles),
                    t.arrowStyles = xt({}, t.offsets.arrow, t.arrowStyles),
                    t
                },
                gpuAcceleration: !0,
                x: "bottom",
      ...
      , Vt = (Ct(Xt, [{
        ...
        value: function() {
            return function() {
                ...
                Lt(this.modifiers, "applyStyle") && (this.popper.removeAttribute("x-placement"),
        ...
        value: function() {
            return function() {
                this.state.eventsEnabled || (this.state = function(t, e, i, n) {
                    i.updateBound = n,
                    Rt(t).addEventListener("resize", i.updateBound, {
                        passive: !0
                    });
                    var s = ct(t);
    ...
    Vt.placements = Bt,
    Vt.Defaults = Kt;
    var Qt, Gt = "dropdown", Jt = "bs.dropdown", Zt = "." + Jt, te = ".data-api", ee = f.fn[Gt], ie = new RegExp("38|40|27"), ne = {
        HIDE: "hide" + Zt,
        HIDDEN: "hidden" + Zt,
        SHOW: "show" + Zt,
        SHOWN: "shown" + Zt,
        CLICK: "click" + Zt,
        CLICK_DATA_API: "click" + Zt + te,
        KEYDOWN_DATA_API: "keydown" + Zt + te,
        KEYUP_DATA_API: "keyup" + Zt + te
    }, se = "disabled", oe = "show", re = "dropdown-menu-right", ae = '[data-toggle="dropdown"]', le = ".dropdown-menu", he = {
        offset: 0,
        flip: !0,
        ...
        display: "string"
    }, ue = ((Qt = de.prototype).toggle = function() {
            ...
            !e) {
                ...
                !n.isDefaultPrevented()) {
                    if (!this._inNavbar) {
                        ...
                        var s = this._element;
                        "parent" === this._config.reference ? s = t : g.isElement(this._config.reference) && (s = this._config.reference,
    ...
    Qt.show = function() {
        if (!(this._element.disabled || f(this._element).hasClass(se) || f(this._menu).hasClass(oe))) {
            ...
            f(i).trigger(e),
            e.isDefaultPrevented() || (f(this._menu).toggleClass(oe),
            f(i).toggleClass(oe).trigger(f.Event(ne.SHOWN, t)))
        }
    }
    ,
    Qt.hide = function() {
        if (!this._element.disabled && !f(this._element).hasClass(se) && f(this._menu).hasClass(oe)) {
            ...
            f(i).trigger(e),
            e.isDefaultPrevented() || (f(this._menu).toggleClass(oe),
            f(i).toggleClass(oe).trigger(f.Event(ne.HIDDEN, t)))
        }
    }
    ,
    Qt.dispose = function() {
        f.removeData(this._element, Jt),
        f(this._element).off(Zt),
        this._element = null,
    ...
    Qt._getConfig = function(t) {
        return t = r({}, this.constructor.Default, f(this._element).data(), t),
        g.typeCheckConfig(Gt, t, this.constructor.DefaultType),
        t
    }
    ,
    ...
    Qt._getPlacement = function() {
        ...
        f(this._menu).hasClass(re) && (e = "top-end")) : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : f(this._menu).hasClass(re) && (e = "bottom-end"),
        e
    }
    ,
    ...
    de._jQueryInterface = function(e) {
        return this.each(function() {
            ...
            if (t || (t = new de(this,"object" == typeof e ? e : null),
            f(this).data(Jt, t)),
            "string" == typeof e) {
                if (void 0 === t[e])
    ...
    de._dataApiKeydownHandler = function(t) {
        if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || f(t.target).closest(le).length)) : ie.test(t.which)) && (t.preventDefault(),
        t.stopPropagation(),
        !this.disabled && !f(this).hasClass(se))) {
    ...
    f(document).on(ne.KEYDOWN_DATA_API, ae, ue._dataApiKeydownHandler).on(ne.KEYDOWN_DATA_API, le, ue._dataApiKeydownHandler).on(ne.CLICK_DATA_API + " " + ne.KEYUP_DATA_API, ue._clearMenus).on(ne.CLICK_DATA_API, ae, function(t) {
        t.preventDefault(),
        t.stopPropagation(),
        ue._jQueryInterface.call(f(this), "toggle")
    ...
    ;
    var pe, fe = "modal", ge = "bs.modal", me = "." + ge, ve = f.fn[fe], _e = {
        backdrop: !0,
        keyboard: !0,
        focus: !0,
        show: !0
    ...
    }, we = "modal-open", Ce = "fade", xe = "show", ke = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Te = ".sticky-top", De = ((pe = Se.prototype).toggle = function(t) {
    ...
    pe._enforceFocus = function() {
        var e = this;
        f(document).off(ye.FOCUSIN).on(ye.FOCUSIN, function(t) {
    ...
    pe._setEscapeEvent = function() {
        var e = this;
        this._isShown && this._config.keyboard ? f(this._element).on(ye.KEYDOWN_DISMISS, function(t) {
    ...
    pe._setResizeEvent = function() {
        var e = this;
        this._isShown ? f(window).on(ye.RESIZE, function(t) {
    ...
    pe._hideModal = function() {
        ...
        this._showBackdrop(function() {
            ...
            t._resetAdjustments(),
            t._resetScrollbar(),
            f(t._element).trigger(ye.HIDDEN)
        })
    }
    ,
    ...
    f(document).on(ye.CLICK_DATA_API, '[data-toggle="modal"]', function(t) {
        ...
        var o = f(e).one(ye.SHOW, function(t) {
            t.isDefaultPrevented() || o.one(ye.HIDDEN, function() {
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(r), l = [].slice.call(i.body.querySelectorAll("*")), n = function(t, e) {
            ...
            s.forEach(function(t) {
                !function(t, e) {
                    ...
                    if (-1 !== e.indexOf(i))
                        return -1 === Ee.indexOf(i) || Boolean(t.nodeValue.match(Ie) || t.nodeValue.match(Ae));
    ...
    var Ne, Oe = "tooltip", Me = "bs.tooltip", $e = "." + Me, He = f.fn[Oe], Le = "bs-tooltip", We = new RegExp("(^|\\s)" + Le + "\\S+","g"), Re = ["sanitize", "whiteList", "sanitizeFn"], Fe = {
        animation: "boolean",
        template: "string",
    ...
    }, Ue = "fade", Ye = "show", Ke = "hover", Ve = ((Ne = Xe.prototype).enable = function() {
        this._isEnabled = !0
    }
    ,
    Ne.disable = function() {
    ...
    Ne.toggle = function(t) {
        if (this._isEnabled)
            if (t) {
                ...
                if (f(this.getTipElement()).hasClass(Ye))
    ...
    Ne.setContent = function() {
        ...
        this.setElementContent(f(t.querySelectorAll(".tooltip-inner")), this.getTitle()),
    ...
    Ne.setElementContent = function(t, e) {
        ...
        t.html(e)) : t.text(e) : this.config.html ? f(e).parent().is(t) || t.empty().append(e) : t.text(f(e).text())
    }
    ,
    ...
    Ne._enter = function(t, e) {
        ...
        (e = e || f(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget,this._getDelegateConfig()),
        f(t.currentTarget).data(i, e)),
        t && (e._activeTrigger["focusin" === t.type ? "focus" : Ke] = !0),
        f(e.getTipElement()).hasClass(Ye) || e._hoverState === qe ? e._hoverState = qe : (clearTimeout(e._timeout),
        e._hoverState = qe,
    ...
    Ne._fixTransition = function() {
        ...
        null === t.getAttribute("x-placement") && (f(t).removeClass(Ue),
    ...
    Xe._jQueryInterface = function(i) {
        return this.each(function() {
            var t = f(this).data(Me)
              , e = "object" == typeof i && i;
            if ((t || !/dispose|hide/.test(i)) && (t || (t = new Xe(this,e),
            f(this).data(Me, t)),
            "string" == typeof i)) {
                if (void 0 === t[i])
                    throw new TypeError('No method named "' + i + '"');
    ...
    ;
    var ri, ai = "scrollspy", li = "bs.scrollspy", hi = "." + li, ci = f.fn[ai], ui = {
        offset: 10,
        method: "auto",
        target: ""
    }, di = {
    ...
    }, fi = "active", gi = ".nav, .list-group", mi = ".nav-link", vi = ".list-group-item", _i = ((ri = bi.prototype).refresh = function() {
        var e = this
    ...
    ri._getConfig = function(t) {
        ...
        return g.typeCheckConfig(ai, t, di),
        t
    }
    ,
    ...
    ri._activate = function(e) {
        ...
        i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(fi),
        i.addClass(fi)) : (i.addClass(fi),
        i.parents(gi).prev(mi + ", " + vi).addClass(fi),
        i.parents(gi).prev(".nav-item").children(mi).addClass(fi)),
        f(this._scrollElement).trigger(pi.ACTIVATE, {
            relatedTarget: e
        })
    }
    ,
    ...
    bi._jQueryInterface = function(e) {
        return this.each(function() {
            ...
            if (t || (t = new bi(this,"object" == typeof e && e),
            f(this).data(li, t)),
            "string" == typeof e) {
                if (void 0 === t[e])
                    throw new TypeError('No method named "' + e + '"');
    ...
    ;
    var yi, wi = "bs.tab", Ci = "." + wi, xi = f.fn.tab, ki = {
        HIDE: "hide" + Ci,
        HIDDEN: "hidden" + Ci,
        SHOW: "show" + Ci,
        SHOWN: "shown" + Ci,
        CLICK_DATA_API: "click.bs.tab.data-api"
    }, Ti = "active", Di = "> li > .active", Si = ((yi = Ei.prototype).show = function() {
        var i = this;
    ...
    f(document).on(ki.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        Si._jQueryInterface.call(f(this), "show")
    }),
    ...
    ;
    var Ii, Ai = "toast", Pi = "bs.toast", Ni = "." + Pi, Oi = f.fn[Ai], Mi = {
        CLICK_DISMISS: "click.dismiss" + Ni,
        HIDE: "hide" + Ni,
        HIDDEN: "hidden" + Ni,
        SHOW: "show" + Ni,
        SHOWN: "shown" + Ni
        ...
        autohide: !0,
        delay: 500
    }, Wi = ((Ii = Ri.prototype).show = function() {
        var t = this;
        function e() {
            t._element.classList.remove("showing"),
            t._element.classList.add($i),
            f(t._element).trigger(Mi.SHOWN),
            t._config.autohide && t.hide()
        }
        if (f(this._element).trigger(Mi.SHOW),
    ...
    Ii.hide = function(t) {
        var e = this;
        this._element.classList.contains($i) && (f(this._element).trigger(Mi.HIDE),
    ...
    Ii._getConfig = function(t) {
        return t = r({}, Li, f(this._element).data(), "object" == typeof t && t ? t : {}),
        g.typeCheckConfig(Ai, t, this.constructor.DefaultType),
        t
    }
    ,
    ...
    Ii._close = function() {
        function t() {
            ...
            f(e._element).trigger(Mi.HIDDEN)
        }
        var e = this;
    ...
    Ri._jQueryInterface = function(i) {
        return this.each(function() {
            var t = f(this)
              , e = t.data(Pi);
            if (e || (e = new Ri(this,"object" == typeof i && i),
            t.data(Pi, e)),
            "string" == typeof i) {
                if (void 0 === e[i])
                    throw new TypeError('No method named "' + i + '"');
            ...
            return this.each(function() {
                function e(t) {
                    if (r) {
                        ...
                        C(t.target || t.srcTarget || t.srcElement).closest("." + w.wrapperClass).is(g.parent()) && n(e, !0),
                ...
                function n(t, e, i) {
                    ...
                    e && (e = parseInt(v.css("top")) + t * parseInt(w.wheelStep) / 100 * v.outerHeight(),
                    ...
                    i && (t = (e = t) / g[0].scrollHeight * g.outerHeight(),
                ...
                function i() {
                    u = Math.max(g.outerHeight() / g[0].scrollHeight * g.outerHeight(), 30),
                    v.css({
                        height: u + "px"
                    });
                ...
                function s() {
                    i(),
                    clearTimeout(h),
                    d == ~~d ? (f = w.allowPageScroll,
                    p != d && g.trigger("slimscroll", 0 == ~~d ? "top" : "bottom")) : f = !1,
                    p = d,
                    u >= g.outerHeight() ? f = !0 : (v.stop(!0, !0).fadeIn("fast"),
                    w.railVisible && _.stop(!0, !0).fadeIn("fast"))
                }
                function o() {
                    w.alwaysVisible || (h = setTimeout(function() {
                        w.disableFadeOut && r || a || l || (v.fadeOut("slow"),
                        _.fadeOut("slow"))
                    }, 1e3))
                }
                ...
                if (g.parent().hasClass(w.wrapperClass)) {
                    ...
                    C.isPlainObject(y)) {
                        if ("height"in y && "auto" == y.height) {
                            ...
                            "height"in y && (b = y.height,
                            g.parent().css("height", b),
                            g.css("height", b));
                        if ("scrollTo"in y)
                            m = parseInt(w.scrollTo);
                        else if ("scrollBy"in y)
                            m += parseInt(w.scrollBy);
                    ...
                    m = C("<div></div>").addClass(w.wrapperClass).css({
                        position: "relative",
                        overflow: "hidden",
                        width: w.width,
                        height: w.height
                    ...
                    g.parent().append(v),
                    g.parent().append(_),
                    w.railDraggable && v.bind("mousedown", function(e) {
                        var i = C(document);
                        return l = !0,
                    ...
                    g.bind("touchmove", function(t) {
                        ...
                        t.originalEvent.touches.length && (n((c - t.originalEvent.touches[0].pageY) / w.touchScrollStep, !0),
                        c = t.originalEvent.touches[0].pageY)
                    }),
                    i(),
                    "bottom" === w.start ? (v.css({
                        top: g.outerHeight() - v.outerHeight()
                    }),
                    n(0, !0)) : "top" !== w.start && (n(C(w.start).position().top, null, !0),
            ...
            if ("undefined" != typeof document) {
                ...
                for (var a = document.cookie ? document.cookie.split("; ") : [], l = /(%[0-9A-Z]{2})+/g, h = 0; h < a.length; h++) {
                    ...
                    try {
                        ...
                        if (u = p.read ? p.read(u, d) : p(u, d) || u.replace(l, decodeURIComponent),
                        this.json)
                            try {
                                u = JSON.parse(u)
                            } catch (t) {}
...
var floatSubMenuTimeout, targetFloatMenu, handleSlimScroll = function() {
    ...
    if (!$(t).attr("data-init")) {
        ...
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? ($(t).css("height", e),
        $(t).css("overflow-x", "scroll")) : $(t).slimScroll(i),
        $(t).attr("data-init", !0),
        $(".slimScrollBar").hide()
    }
    ...
    $(document).on("click", ".sidebar .nav > .has-sub > a", function() {
        ...
        0 === $(".page-sidebar-minified").length && ($(t).closest("li").addClass("closing"),
        ...
        $(e).slideToggle(i, function() {
            ...
            $(e).is(":visible") ? ($(t).addClass("expand"),
            $(t).removeClass("closed")) : ($(t).addClass("closed"),
    ...
    $(document).on("click touchstart", ".sidebar", function(t) {
        0 !== $(t.target).closest(".sidebar").length ? n = !0 : (n = !1,
        t.stopPropagation())
    }),
    $(document).on("click touchstart", function(t) {
        0 === $(t.target).closest(".sidebar").length && (n = !1),
        0 !== $(t.target).closest("#float-sub-menu").length && (n = !0),
        t.isPropagationStopped() || !0 === n || ($("#page-container").hasClass("page-sidebar-toggled") && (n = !0,
        $("#page-container").removeClass("page-sidebar-toggled")),
        $(window).width() <= 767 && $("#page-container").hasClass("page-right-sidebar-toggled") && (n = !0,
    ...
    $(document).on("click", "[data-click=sidebar-toggled]", function(t) {
        ...
        var e = "page-sidebar-toggled"
          , i = "#page-container";
        $(i).hasClass(e) ? $(i).removeClass(e) : !0 !== n ? $(i).addClass(e) : n = !1,
    ...
    $(document).on("click", "[data-click=panel-remove]", function(t) {
        ...
        4 <= e && e < 5 ? $(this).tooltip("dispose") : $(this).tooltip("destroy"),
    ...
    $(t).sortable({
        ...
        stop: function(t, e) {
            e.item.find(".panel-title").append('<i class="fa fa-refresh fa-spin m-l-5" data-id="title-spinner"></i>'),
    ...
    $(document).on("change", '.theme-panel [name="sidebar-grid"]', function() {
        var t = !1;
        $(this).is(":checked") ? ($("#sidebar").addClass("sidebar-grid"),
        t = !0) : $("#sidebar").removeClass("sidebar-grid"),
        Cookies && Cookies.set("sidebar-grid", t)
    }),
    $(document).on("change", '.theme-panel [name="sidebar-gradient"]', function() {
        var t = !1;
        $(this).is(":checked") ? ($("#page-container").addClass("gradient-enabled"),
        t = !0) : $("#page-container").removeClass("gradient-enabled"),
    ...
    $(document).on("change", '.theme-panel [name="sidebar-fixed"]', function() {
        ...
        t = !0) : ($("#page-container").removeClass("page-sidebar-fixed"),
    ...
    $(document).on("change", '.theme-panel [name="header-fixed"]', function() {
        var t = !1;
        $(this).is(":checked") ? ($("#header").addClass("navbar-fixed-top"),
        $("#page-container").addClass("page-header-fixed"),
        t = !0) : ($('.theme-panel [name="sidebar-fixed"]').is(":checked") && (alert("Default Header with Fixed Sidebar option is not supported. Proceed with Default Header with Default Sidebar."),
    ...
    function e(t, e) {
        ...
        case "next":
            ...
            0 !== a && ("rtl" != $("body").css("direction") ? $(i).find(".nav.nav-tabs").animate({
                marginLeft: "-" + a + "px"
            }, 150, function() {
        ...
        case "prev":
            var l;
            a = (l = -s) <= o ? ($(i).removeClass("overflow-left"),
            0) : l - o + 80,
            "rtl" != $("body").css("direction") ? $(i).find(".nav.nav-tabs").animate({
                marginLeft: "-" + a + "px"
            }, 150, function() {
        ...
        $(".tab-overflow").each(function() {
            !function(t, e) {
                ...
                s <= o) {
                    var l = o - s;
                    a != o && (l += 40),
                    "rtl" == $("body").css("direction") ? $(t).find(".nav.nav-tabs").animate({
                        marginRight: "-" + l + "px"
                    }, r) : $(t).find(".nav.nav-tabs").animate({
                        marginLeft: "-" + l + "px"
                    }, r)
                }
                o != a && s <= a ? $(t).addClass("overflow-right") : $(t).removeClass("overflow-right"),
                s <= o && s <= a ? $(t).addClass("overflow-left") : $(t).removeClass("overflow-left")
            }(this, 0)
        })
    }
    ...
    function e(t, e) {
        ...
        case "next":
            ...
            0 !== a && ("rtl" != $("body").css("direction") ? $(i).animate({
                marginLeft: "-" + a + "px"
            }, 150, function() {
        ...
        case "prev":
            var l;
            a = (l = -s) <= o ? ($(i).find(".menu-control.menu-control-left").removeClass("show"),
            0) : l - o + 88,
            "rtl" != $("body").css("direction") ? $(i).animate({
                marginLeft: "-" + a + "px"
            }, 150, function() {
    ...
    $(document).on("click", '[data-toggle="nav-profile"]', function(t) {
        ...
        $(i).is(":visible") ? ($(e).removeClass("active"),
        $(i).removeClass("closing")) : ($(e).addClass("active"),
        $(i).addClass("expanding")),
        $(i).slideToggle(n, function() {
            $(i).is(":visible") ? ($(i).addClass("expand"),
            $(i).removeClass("closed")) : ($(i).addClass("closed"),
    ...
    $(document).on("click", "#float-sub-menu li.has-sub > a", function(t) {
        var e = $(this).next(".sub-menu")
          ...
          , l = !1
          , h = !1;
        $(e).is(":visible") ? ($(i).addClass("closing"),
        l = !0) : ($(i).addClass("expanding"),
        h = !0),
        $(e).slideToggle({
            duration: 250,
            progress: function() {
            ...
            complete: function() {
                $(e).is(":visible") ? ($(i).addClass("expand"),
                $(i).removeClass("closed")) : ($(i).addClass("closed"),
                $(i).removeClass("expand")),
        ...
        mouseenter: function() {
            if ($("#page-container").hasClass("page-sidebar-minified")) {
                ...
                if (e) {
                    ...
                    $("#page-container").append(e)) : ($("#float-sub-menu").attr("data-offset-top", s),
                    $("#float-sub-menu").attr("data-menu-offset-top", s),
...
}, CLEAR_OPTION = "", handleAjaxMode = function(r) {
    ...
    function l(t) {
        t ? ($("#page-content-loader").remove(),
        $("body").removeClass("page-content-loading")) : 0 === $("#page-content-loader").length && ($("body").addClass("page-content-loading"),
        $("#content-main").append('<div id="page-content-loader"><span class="spinner"></span></div>'))
    }
    function e(t, e, i) {
        Pace.restart(),
        l(!1),
        ...
        function(t) {
            ...
            0 !== $(e).length && ($("#sidebar li").removeClass("active"),
            $(e).closest("li").addClass("active"),
            $(e).parents().addClass("active"))
        }(t),
        CLEAR_OPTION && (App.clearPageOption(CLEAR_OPTION),
        CLEAR_OPTION = ""),
        i || function(t) {
            var e = t.replace("#", "")
              , i = window.navigator.userAgent.indexOf("MSIE ");
            //The line below creates the url posted in the address box
            i && 0 < i && i < 9 ? window.location.href = e : history.pushState("", "", e)
        }(t);
        var n = t.replace("#", "")
          , s = r.ajaxType ? r.ajaxType : "GET"
          , o = r.ajaxDataType ? r.ajaxDataType : "html";
        e && (o = $(e).attr("data-type") ? $(e).attr("data-type") : o,
        targetDataDataType = $(e).attr("data-data-type") ? $(e).attr("data-data-type") : o),
        $.ajax({
            url: n,
            type: s,
            dataType: o,
            success: function(t) {
                $("#content-main").html($(t).find('#content-main').html()),
                document.title = $(t).filter('title').text()
            },
